...
if (isset($_GET['save_cancel'])){
   ...
   while ($i < $num)
      ...
      //---------------------------------
      $query5= "INSERT INTO supplierstrfile VALUES('$codes','$desc','$date','$ref_no','$narration','RC','-$amount','RC','$cheque_no','admin',' ','$mydates','0','$desc','0')";
...
function showUser(str) {    
    if (str == "") {
        ...
        xmlhttp.open("GET","getsupplier4.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
