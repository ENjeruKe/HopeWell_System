...
'$qty_s','ISP','$date','ADMIN','$rate','$total','$ref_no','$adm_no')";
      ...
      VALUES('$adm_no','$patient','$date','$ref_no','$desc','CR','-$total','$g_id','$gledger','CR',' ','ADMIN',' 
      ','$date','$qty_s','')";
      ...
      ','$date','$debt_control','$ref_no','CR','$desc','-$total','ADMIN','CHIROMO')";
      ...
      $query8= "INSERT INTO gltransf VALUES(' ','$date','$gledger','$ref_no','DB','$desc',
     '$total','ADMIN','CHIROMO')";
      $result8 =mysql_query($query8);
...
<form action ="issuetopatients_return.php" method ="GET">
<?php
...
<h2>Post Medication | Return from Patients</h2><img src='chiromo-logo2.jpg' alt='statement' height='50' width='400'>
