<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="nutrients.php"><i class="icon-user-md icon-1x"></i><span>Nutrition Clinic</span></a>       </li>

        <li><a href="nu_st_reg.php"><i class="icon-user-md icon-1x"></i><span>Add Nutrition Prescription</span></a>  </li>             
