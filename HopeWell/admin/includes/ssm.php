...
$_SESSION['edit'] = $edit;
 ...
 //if ($users=='yes'){                
       echo" <li><a href='siftz.php'><i class='fa fa-circle-o'></i><span>Shift Reports</span></a></li>";
// }else{           
     echo" <li><a href='cus.php'><i class='fa fa-circle-o'></i><span>Close User Shift</span></a></li>";
 //}     
 echo" <li><a href='sift.php'><i class='fa fa-circle-o'></i><span>Cashier Manager Shift</span></a></li>";
