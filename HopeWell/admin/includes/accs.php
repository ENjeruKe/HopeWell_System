...
$_SESSION['edit'] = $edit;
       ...
       echo"<li><a href='trans_byrevcode.php' target ='_blank'><i class='fa fa-line-chart'></i><span>Transactions by revenue code</span></a></li>";
if ($stmt=='yes'){                           
       echo"<li><a href='statements.php'><i class='fa fa-line-chart'></i><span>Statements</span></a>  </li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>Statements</span></a>  </li>";
}
if ($paym=='yes'){                
       echo"<li><a href='payments.php'><i class='fa fa-line-chart'></i><span>Payments</span></a>          </li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>Payments</span></a>          </li>";
}

if ($invo=='yes'){                
       echo"<li><a href='invoices.php'><i class='fa fa-line-chart'></i><span>Invoices</span></a> </li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>Invoices</span></a> </li>";
}
if ($gl=='yes'){                
       echo"<li><a href='gl.php'><i class='fa fa-line-chart'></i><span>General Ledger</span></a></li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>General Ledger</span></a></li>";
}
if ($blnc=='yes'){                
       echo"<li><a href='bal.php'><i class='fa fa-line-chart'></i><span>Balances</span></a></li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>Balances</span></a></li>";
}

if ($in_p=='yes'){                
       echo"<li><a href='in.php'><i class='fa fa-line-chart'></i><span>In-Patients</span></a></li>";
 }else{           
       echo"<li><a href='#'><i class='fa fa-line-chart'></i><span>In-Patients</span></a></li>";
}
