...
echo"<form action ='issue_to_patients.php' method ='GET'>";
 echo"<table border = '0'><td width ='400'><input type='text' id ='item1' name='item1' size ='35' value ='$description' 
</td><!--td width ='15'><input type='text' id ='x_amount_three' name='x_amount_three' size='15'></td--><td><input type='text' id ='amount_three' name='amount_three' size='10' value ='$item_price'></td>";
