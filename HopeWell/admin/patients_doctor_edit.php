...
echo"<tr><td width ='50'><b>Temp.</td><td width='20' align='left'><input type='text' id ='temp' name='temp' size='10' value='$temp' ></td><td width ='50'><b>B.P</td><td width='50' align='left'><input type='text' id ='b_p' name='b_p'  
 size='10' value='$b_p'></td><td width ='50'><b>Height</td><td width='50' align='left'><input type='text' id ='height' name='height'  
...
echo"</td><td>|</td><td><a href=javascript:popcontact3('admit_patients.php?accounts=$adm_no')><h3>Admit</h3></a></td></table>";
//}";
?>
...
<!--OBJECT data='charged_drugs.php' type='text/html' style='margin: 0; width: 600px; height: 200px; padding 0px; text-align:left;'></OBJECT><br><br-->
