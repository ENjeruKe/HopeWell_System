...
<h1>Medi+ TRINITY CARE CENTER</h1></font>
</div-->
...
//     echo"<a href='#'><i class='icon-credit-card icon-2x'></i><h4><font color ='blue'>Accounts Dept</font></h4></a>";
}
...
//------------------
if ($dent=='yes'){
    echo"<a href='dent.php'><i class='fa-smile-o icon-2x'></i><h4><font color ='blue'>Dental Department</font></h4></a>";
}else{     
//     echo"<a href=''><i class='fa-smile-o icon-2x'></i><h4><font color ='blue'>Dental Department</font></h4></a>";
}


if ($adms=='yes'){
   echo"<a href='phy.php'><i class='fa-wheelchair icon-2x'></i><h4><font color ='blue'>Physiotherapy</font></h4></a>";
}else{   
//    echo"<a href='#'><i class='fa-wheelchair icon-2x'></i><h4><font color ='blue'>Physiotherapy</font></h4></a>";
}    
if ($rad=='yes'){
    echo"<a href='opt.php'><i class='fa-eye icon-2x'></i><h4><font color ='blue'>Optical</font></h4></a>";
}else{
//     echo"<a href='#'><i class='fa-eye icon-2x'></i><h4><font color ='blue'>Optical</font></h4></a>";
}
