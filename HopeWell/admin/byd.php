...
<?php
 ...
 if (isset($_GET['print'])){
   ...
   echo"<h4> DRUG DISPENSION REPORT <img src='space.jpg' style='width:20px;height:2px;'>"."Dated from: ".$date1."<img src='space.jpg' style='width:20px;height:2px;'>"."To :".$date2;
echo"</h4>";
...
<div class="w3-container w3-teal">
  <h1><font color ='green'> DRUG DISPENSION REPORT </font></h1>
</div>
...
<?php
  echo"<br>";
  echo"<form action ='byd.php' method ='GET'>";
