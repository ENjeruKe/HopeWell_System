...
<form action ="dental_patients_register_doctor.php" method ="GET">
<?php
...
//echo"<a href=javascript:popcontact7('doc_window_23.php?accounts=$adm_no&accounts3=$ref_nos')><img src='folloup.jpg' alt='scan' style='width:60%'></a></td><td width='30%'></td><table><!--br><B>CHIEF COMPLAINT (C.O)<br>";




echo"<table width='100%'><td width='20%'>";
echo"<a href=javascript:popcontact7('doc_window_19.php?accounts=$adm_no&accounts3=$ref_nos')><img src='investigate.jpg' alt='scan' style='width:100%'></a></td><td width='20%'>";


echo"<a href=javascript:popcontact7('proce_21.php?accounts=$adm_no&accounts3=$ref_nos')><img src='pro.jpg' alt='scan' style='width:100%'></a></td><!--td width='15%'>";

echo"<a href=javascript:popcontact7('rad_21.php?accounts=$adm_no&accounts3=$ref_nos')><img src='rad.jpg' alt='scan' style='width:70%'></a></td--><td width='20%'>";

echo"<a href=javascript:popcontact7('doc_window_21.php?accounts=$adm_no&accounts3=$ref_nos')><img src='medication.jpg' alt='scan' style='width:100%'></a></td><td width='20%'>";

//echo"<a href=javascript:popcontact7('aller.php?accounts=$adm_no&accounts3=$ref_nos')><img src='aller.jpg' alt='scan' style='width:100%'></a></td><td width='20%'>";
...
echo"<!--a href=javascript:popcontact7('dental_21.php?accounts=$adm_no&accounts3=$ref_nos')><img src='dental.jpg' alt='scan' style='width:100%'></a></td--><!--td width='15%'></td--></table>";
echo"<br><B>CHIEF COMPLAINT (C.O)<br>";
...
while ($row=mysql_fetch_array($hasil)) 
  { 
      $id      = mysql_result($result,$i,"adm_no");          
      $name        = mysql_result($result,$i,"name"); 
      $med1_dx2       = mysql_result($result,$i,"drug5_issued"); 
  }
...
echo"<textarea rows='3' cols='100%' name='textarea7'>$sign4</textarea><br-->";
//------------------------------------------------------------------------------
...
//echo"<form action ='patients_register_doctor.php' method ='GET'>";
//$_SESSION['update'] ='10';
echo"<textarea rows='5' cols='100%' name='textarea10'>$sign4</textarea><br>";
//------------------------------------------------------------------------------
...
echo"<textarea rows='5' cols='100%' name='textarea11'>$sign4</textarea><br>";
//------------------------------------------------------------------------------
...
//echo"<form action ='patients_register_doctor.php' method ='GET'>";
//$_SESSION['update'] ='12';
echo"<textarea rows='5' cols='100%' name='textarea12'>$sign4</textarea><br>";
//------------------------------------------------------------------------------
