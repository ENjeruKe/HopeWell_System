...
//For save and print button the correct on
//----------------------------------------
if (isset($_GET['save_cancel'])){
   ...
   $query = "delete FROM stock_adj WHERE description <>'' and qty =0" ;
   ...
   while ($i < $num)
      ...
      $variance =$rate*-1;
      $query4= "INSERT INTO st_trans VALUES('','$codes','$desc','Stock Take Variance','$variance','ADJ','$date','ADMIN','$rate','$variance','$ref_no','','','','','','')";
      $result4 =mysql_query($query4);

      //$totals = $cost*$qty;
      //$patient =$patients_name;
      $query4= "INSERT INTO st_trans VALUES('','$codes','$desc','Stock Take','$qty','ADJ','$date','ADMIN','$rate','$total','$ref_no','','','','','','')";
      $result4 =mysql_query($query4);
      //Now go and update the receipt file


      $query66= "INSERT INTO stocktake VALUES('','$codes','$desc','$rate','$qty','$total','$total','$date','$ref_no')";
      $result66 =mysql_query($query66);
      //Now go and update the receipt file

      
 
     //Go and update general ledger
     //----------------------------
$med_cost = $totals;
...
$credit_account ='STOCK TAKE';
$query5= "INSERT INTO gltransf    VALUES('','$date','$debit_account','$ref_no','TAKE','$patients_name','$med_cost','$username','CONTROL')";
...
echo'here6';
   ...
   //--------------------------
   $query5= "INSERT INTO gltransf VALUES('','$date','$credit_account','$ref_no','TAKE','$patients_name','-$med_cost','$username','$acc_type')";
   $result5 =mysql_query($query5);
...
if (isset($_GET['save_cancel8'])){  
   ...
   while ($i < $num)
      ...
      $query3= "UPDATE stockfile SET qty ='$qty2' WHERE search_name ='$desc'";
      $result3 =mysql_query($query3);
...
//if (isset($_GET['accounts6'])){ 
   ...
   $query9= "INSERT INTO stock_adj  VALUES('','$location','$description','$amount','$qty','$total','$total','$search_id','')";
...
function showUser(str) {    
    if (str == "") {
        ...
        xmlhttp.open("GET","getreturns.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<!--body background='images/backgrounds.jpg'-->
...
<form action ="stock_take.php" method ="GET">
<?php
...
/////////////////////////////////
echo"<table bgcolor ='red' border = '0' border color = 'black' width ='100%'><th width ='60%' align ='left' bgcolor ='black'><font color ='white'>Item Description</th><th width ='10%' bgcolor ='black'><font color ='white'>QTY</th><th width ='10%'bgcolor ='black'><font color ='white'>Count</th><th width ='10%' bgcolor ='black'><font color ='white'>Variance</th><th width ='10%' bgcolor ='black'><font color ='white'>Action</th></th>";
 ...
 while ($row=mysql_fetch_array($hasil)) 
      ...
      if ($desc > ' '){
        ...
        ='$search_id' readonly></td-->";
         ...
         echo"<td width ='60%'><input type='text' id ='s_desc_three' size ='60' name='s_desc_three' value 
        ='$desc'></td>";
      }else{
         echo"<tr>";
         echo"<!--td width ='5'><input type='text' id ='search_id' size ='5' name='search_id' value 
    ...
    if ($qty > 0){
      ...
      $aa8=$row['id'];        
if ($qty <>0){
echo"<td width ='5%' align ='right'><a href='stock_take.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}
...
?>
<?php
echo"<table bgcolor ='green' border = '0' border color = 'black' width ='100%'><td width ='100%'</td></table>";
...
if (isset($_GET['save_cancel44'])){
   ...
   while ($i < $num)
      ...
      $codes2   = mysql_result($result,$i,"location");        
      $desc    = mysql_result($result,$i,"description");   
      $rate    = mysql_result($result,$i,"sell_price");   
      $qty     = mysql_result($result,$i,"qty");  
      $qty_s   = mysql_result($result,$i,"qty");  
      ...
      $query4= "INSERT INTO st_trans VALUES('','$codes2','$desc','Stock Take','$qty','ADJ','$date','ADMIN','$qty','$total','$ref_no','','','','','')";
      $result4 =mysql_query($query4);
      //Now go and update the receipt file

      $query= "INSERT INTO stocktake VALUES('','$codes2','$desc','$rate','$qty','$total','$total','$date','$ref_no')";
      $result =mysql_query($query);
      //Now go and update the receipt file
...
if (isset($_GET['add_next'])){
   ...
   $query= "INSERT INTO stock_adj VALUES('','$codes2','$description','$item_price','$qty','$total','$total','$search_id','')";
   $result =mysql_query($query);


   $query3 = "DELETE FROM stock_adj WHERE qty = 0 and sell_price >0";
   $result3 =mysql_query($query3) or die(mysql_error());
