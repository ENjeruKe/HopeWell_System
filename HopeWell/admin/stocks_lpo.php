...
function myage() {
    ...
    var age1 = document.getElementById('date').value;   
    alert(a);
    txt2 = a;
    document.getElementById("real_date").value = txt2;
}
</script>
...
if ($date==''){
    echo"<font color ='red'><h1>Please put date before you can save.....</h1></font>";
    die();
}
   //Get the receipt No.   

      $query4= "INSERT INTO next_lpo VALUES('')";
      $result4 =mysql_query($query4);



      $query2 = "select * FROM next_lpo";
...
while ($i2 < $num2)
{
$inv_no   = mysql_result($result2,$i2,"next_lpo");
 $i2++;
 }



     $query = "select * FROM stock_lpo_tmp WHERE description <>''" ;
     ...
     while ($i < $num)
      ...
      $old_bal  = mysql_result($result,$i,"credit_rate"); 
      $disc     = mysql_result($result,$i,"line_no"); 
    ...
    //  $desc2 ='GRN'.':'.$ref_no.':'.$deliv_no;
      ...
      $query4= "INSERT INTO lpo_trans VALUES('','$location1','$desc','$desc2','$qty_s','LPO','$date','$username','$rate','$total','$inv_no','$supplier','$old_bal','$disc','$tot_vat','$tot_disc','$net_total','$real_date')";
      $result4 =mysql_query($query4);
...
echo"<br><br><br><br>";
echo"Official Stamp<br><br>";
echo"<a href=javascript:popcontact505('view_lpo.php?invoice=$inv_no')><b><font color ='black'>Print this Order</font></b></a>";
   ...
   //-----------------------------
   $query3 = "DELETE FROM stock_lpo_tmp WHERE qty > 0";
   $result3 =mysql_query($query3) or die(mysql_error());
   die();
}
...
if (isset($_GET['accounts5'])){      
   ...
   $query3 = "DELETE FROM stock_lpo_tmp WHERE id ='$record'";
   $result3 =mysql_query($query3) or die(mysql_error());
...
// sql to create table
$sql = "CREATE TABLE stock_lpo_tmp (
...
//if (isset($_GET['accounts6'])){ 
   ...
   $query= "CREATE TEMPORARY TABLE stock_lpo_tmp IF NOT EXISTS stock_lpo_tmp (location varchar(100) NOT NULL,
   ...
   $query9= "INSERT INTO stock_lpo_tmp  VALUES('','$location','$description','$amount','$qty','$old_balance','$total','$search_id','$disc2','$vats','$disc',
'$net_total')";
   $result9 =mysql_query($query9);
   $myDate =date('y-m-d');


   $query3 = "DELETE FROM stock_lpo_tmp WHERE description <>'' and qty = 0";
   $result3 =mysql_query($query3) or die(mysql_error());
...
function showUser(str) {    
    if (str == "") {
        ...
        xmlhttp.open("GET","getpricelpo.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<form action ="stocks_lpo.php" method ="GET">
<?php
...
//echo"<table bgcolor ='red' border = '0' border color = 'black' width ='100%'><th width ='350' align ='left'>Item Description</th><th width ='100'>@Cost</th><th width ='50'>Qty</th><th width ='50'>V.A.T</th><th width ='10'>%Disc.</th><th width ='100'>Total</th><th width ='50' align ='right'>Action</th></th></table>";
...
echo"<th width ='5%'  bgcolor='blue' align ='right'><font color='white'><h4>Action</h4></font></th></table>";
 ...
 $query= "SELECT * FROM stock_lpo_tmp " or die(mysql_error());
 $result =mysql_query($query) or die(mysql_error());
 $num =mysql_numrows($result) or die(mysql_error());
 $tot =0;
 $i = 0;
 ...
 while ($row=mysql_fetch_array($hasil)) 
      ...
      if ($desc > ' '){
         ...
         echo"<td align ='left' width ='5'><input type='text' name='search_id'  id ='search_id' value='$search_id' size ='5' readonly></td>";
    ...
    if ($qty > 0){
        ...
        echo"<td width ='1%'><!--input type='text' id ='s_no_three' name='no_disc' size='5' value ='$disc' readonly--></td>";
...
//</td>";
      ...
      $aa8=$row['id'];        
if ($aa8<>'1'){
echo"<td width ='90' align ='right'><a href='stocks_lpo.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}
...
while ($i2 < $num2)
{
$ref_no   = mysql_result($result2,$i2,"next_lpo");
 $i2++;
 }
$ref_no++;


//echo"<input type='text' name ='real_date' id ='real_date'>";

echo"<img src='ico/black.jpg' style='width:100%;height:1px;'><br>";
echo"<font size ='20'><table border ='0' width ='100%'><tr><td width ='100'><b>Date</b></td><td>
 <input type='date' name ='date' id ='date' placeholder='dd-mm-yyyy' required></td><td width ='100' align ='right'></td><td width ='100' align ='right'><b>LPO No.</b></td><td width ='100' align ='right'><input type='text' name='grn_no' size ='10' value='$ref_no' readonly></td><td></td><td align ='right'><b>Total:</b></td><td width ='10' align ='right'><b><input type='text' size ='10' name='gross_total' id='gross_total' value='$tot_amt' readonly></b></td></tr>";

echo"<tr><td width ='100'><!--b>Invoice No.</b--></td><td><input type='hidden' name='inv_no' size ='10' ></td><td width ='100' align ='right'></td><td width ='100' align ='right'><!--b>Delivery No.</b--></td><td width ='100' align ='right'><input type='hidden' name='deliv_no' size ='10'></td><td></td><td align ='right' width ='200'><b>Tot-VAT:</b></td><td width ='10' align ='right'><b><input type='text' size ='10' name='tot_vat' id='tot_vat' value='$tot_vats'readonly></b></td></tr>";
...
if (isset($_GET['save_cancel77'])){
   ...
   $query = "select * FROM stock_lpo_tmp" ;
   $result =mysql_query($query) or die(mysql_error());
   $id = 0;
   $nRecord = 1;
   $No = $nRecord;
