...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM medicalfile where (status ='To cash office' or status ='To Pharmacy' or status ='Completed') and date ='$mdate' and type='Outpatient' ORDER BY dose7" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where (status ='To cash office' or status ='To Pharmacy' or status ='Completed') and date ='$mdate' and type='Outpatient' ORDER BY dose7" or die(mysql_error());
}
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      echo"</td>";
      echo"<td width ='200' align ='left'><a href='patients_doctor_edit5.php?accounts3=$bb&accounts=$aa&ref_no=$aa2'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
