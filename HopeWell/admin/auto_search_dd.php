...
function showUser(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_dd.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<input id="dd_user_input" type="text" size ='60' class="search_form3" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" value="Type your Input Here" onchange="showUser(this.value)"
/><br>
