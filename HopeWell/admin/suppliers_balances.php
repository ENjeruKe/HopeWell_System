...
if (isset($_GET['print'])){
   ...
   echo"<br><br><table><tr><td width ='350' align ='left'><b>SUPPLIERS BALANCES</b></td><td width ='500' align ='right'><b>Print Date:.$date</b></td></tr></table>";

   $query= "SELECT * FROM suppliersfile WHERE account_name > '' ORDER BY account_name " or die(mysql_error());
   $SQL  = "SELECT * FROM suppliersfile WHERE account_name > '' ORDER BY account_name " or die(mysql_error());
   $result =mysql_query($query) or die(mysql_error());
   $num =mysql_numrows($result) or die(mysql_error());
   $tot =0;
   $i = 0;
...
<table><td><h1>Suppliers Balances</h1></td><td width ='500'></td><td><img src='images/tested.gif-c200' alt='statement' height='70' width='100'></td></table>

<body background="images/background.jpg">
<form action ="suppliers_balances.php" method ="GET">
<table>
...
if (isset($_GET['search'])){
   ...
   if ($search_by =='Record'){
     $query = "select * FROM  suppliersfile WHERE client_id LIKE '%$search%' ORDER BY account_name" ;
     $SQL = "select * FROM  suppliersfile WHERE client_id LIKE '%$search%' ORDER BY account_name" ;
   }
   if ($search_by =='Date'){
     $query = "select * FROM  suppliersfile WHERE register_date LIKE '%$search%' ORDER BY account_name" ;
     $SQL   = "select * FROM  suppliersfile WHERE register_date LIKE '%$search%' ORDER BY account_name" ;
   }
   if ($search_by =='Account'){
     $query = "select * FROM  suppliersfile WHERE account_name LIKE '%$search%' ORDER BY account_name" ;
     $SQL   = "select * FROM  suppliersfile WHERE account_name LIKE '%$search%' ORDER BY account_name" ;
   }
 }else{
   $query= "SELECT * FROM suppliersfile WHERE account_name > '' ORDER BY account_name" or die(mysql_error());
   $SQL  = "SELECT * FROM suppliersfile WHERE account_name > '' ORDER BY account_name" or die(mysql_error());
