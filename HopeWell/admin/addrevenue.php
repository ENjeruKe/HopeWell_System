...
<form action="saverevenue.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Add Revenue</h4></center>
<hr>
<div id="ac">
<span>Service : </span><input type="text" style="width:265px; height:30px;" name="name" required/><br>

<span>Cost Rate : </span><input type="text" style="width:265px; height:30px;" name="address" /><br>
