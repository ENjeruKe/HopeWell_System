...
echo"<td width ='50'><b>Temp.</td><td width='20' align='left'><input type='text' id ='temp' name='temp' size='10' value='$temp' ></td><td width ='50'><b>Ref:</td><td width='50' align='left'><input type='text' id ='height' name='height'  
...
echo "<br><br><table width ='700'><th width ='400' align ='left'><font color ='red'>Med. Test Requested</font></th><th width ='750' align ='right'>";
//echo"<table width ='100%' border='2'><td width ='300' align ='left'><h3><font color ='red'>Med.Test Request</font></h3></td><td width ='500'></td><td width ='900' align ='right'>";
if ($results =='Yes'){
   echo"<a href=javascript:popcontact505('view_labresult.php?accounts3=$ref_nos')>Print results</a>";
}else{
...
$sql="SELECT * FROM  auto_transact WHERE line_no = '$adm_no' and date ='$date' and location='Lab'";
...
if ($payer==''){
   ...
   //if ($test1_paid >0){
   //echo"<br><textarea rows='6' cols='50' id='test1_result' name='test1_result'></textarea>";
   //}
   echo"</td></tr>";
