...
//----------
         ...
         $query2 = "select * FROM stockfile WHERE description ='$desc' and location ='$cost_location'" ;
         ...
         $qty = $qtys-$qty_s;
         $query3= "UPDATE stockfile SET qty ='$qty' WHERE description ='$desc' and location ='$cost_location'";
         $result3 =mysql_query($query3);


         $query4= "INSERT INTO st_trans VALUES('','$cost_location','$desc','$patient','-$qty_s','ISP','$date','$username','$rate','$total','$ref_no','$adm_no','','','','','')";
      ...
      VALUES('','$adm_no','$patient','$date','$ref_no','$desc','DB','$rate','$chargable','$gledger','DB',' ','$username',' 
      ','$date','$qty_s','')";
      $result5 =mysql_query($query5);
      }
      ...
      ','$date','$debt_control','$ref_no','DB','$patientsz','$total','$username','$type')";
      ...
      $query8= "INSERT INTO gltransf VALUES(' ','$date','$gledger_gl','$ref_no','CR','$patientsz',
     '-$total','$username','$type')";
      $result8 =mysql_query($query8);
...
//if (isset($_GET['accounts6'])){ 
   ...
   if ($store_select ==' '){
       echo"<font color='red'>Kindly select the store you are dispensing from.........</font>";
   }
...
<form action ="ip_issuetopatients.php" method ="GET">
<?php
...
echo"<br></font>You can change the store by simply changing 'From store' then click on Issue to patients";
echo"<img src='ico/black.jpg' style='width:100%;height:1px;'><br>";   

//echo"<table bgcolor ='red' border = '0' border color = 'black' width ='100%'><th width ='500' align ='left'>Item Description</th><th width ='100' align ='left'>Price</th><th width ='220' center>Qty</th><th width ='220' align ='center'>Total</th><th width ='100'>Action</th></th></table>";
...
echo"<th width ='10%' bgcolor ='green'><font color ='white'><h4>Action</h4></font></th></table>";
 ...
 //while ($row=mysql_fetch_array($hasil)) 
   while ($i7 < $num7)
    ...
    if ($qty > 0){
        echo"<td width ='10%' align ='left'><input type='text' id ='s_amount_three' name='amount_three' value 
        ='$price' readonly></td>";
        echo"<td width ='10%' align ='left'><input type='text' id ='s_no_three' name='s_no_three' value ='$qty'></td>";
        echo"<td width ='10%' ><input type='text' id ='s_result_three' name='s_result_three' value 
      ...
      //$aa8=$row['id'];        
if ($qty <>0){
echo"<td width ='10%' align ='right'><a href='ip_issuetopatients.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}else{
...
if (isset($_GET['save_cancel77'])){
   ...
   while ($i < $num)
      ...
      //Add Qty in file
      $query2 = "select * FROM $tablez WHERE description ='$desc' and location ='$cost_location'" ;
      $result2 =mysql_query($query2) or die(mysql_error());
      $id = 0;
      $nRecord = 1;
      $No = $nRecord;
...
if (isset($_GET['add_next'])){
   ...
   //get price for this item as you save it in temporary file
   $item_desc =" ";
   $query2 = "select * FROM stockfile WHERE substr(description, -10) ='$desc'";
   //location ='$location'" ;
   $result2 =mysql_query($query2) or die(mysql_error());
   $id = 0;
   $nRecord = 1;
