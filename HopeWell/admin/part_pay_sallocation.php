...
if (isset($_GET['accountsspay'])){      
   ...
   //Asign the receipt No.
   //---------------------
   $query3 = "select * FROM supplierstrfile where id ='$record'" ;
   $result3 =mysql_query($query3) or die(mysql_error());
   $num3 =mysql_numrows($result3) or die(mysql_error());
   $i3=0;
   while ($i3 < $num3)
     ...
     $payer    = mysql_result($result3,$i3,"account_name");  
...
if (isset($_GET['save_cancel'])){
   ...
   $query3 = "UPDATE suppliers_allocate2 set qty = '$paid' WHERE id ='$ref_no'";
   $result3 =mysql_query($query3) or die(mysql_error());
...
?>
 ...
 <?php
 echo"<form action ='part_pay_sallocation.php' method ='GET'>";
