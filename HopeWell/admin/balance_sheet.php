...
$current = 0;
$fixed = 0;
   $query3 = "SELECT * FROM glaccountsf WHERE type like '%CURRENT ASSET%' ORDER BY account_name"; 	 
...
while ($i3 < $num3){
   ...
   $query3 = "SELECT * FROM glaccountsf WHERE type like '%Fixed Asse%' ORDER BY account_name"; 	 
   $result3 = mysql_query($query3);
   $num3 =mysql_numrows($result3);
   $tot_cred =0;
   $i3 =0;
...
$current_liab = 0;
$long_liab = 0;
 $query3 = "SELECT * FROM glaccountsf WHERE type like '%CURRENT LIABILITY%' ORDER BY account_name"; 	 
   $result3 = mysql_query($query3);
   $num3 =mysql_numrows($result3);
   $tot_cred =0;
   $i3 =0;
...
while ($i3 < $num3){
 ...
 $query3 = "SELECT * FROM glaccountsf WHERE type like '%LONG-TERM LIABILITY%' ORDER BY account_name"; 	 
   $result3 = mysql_query($query3);
   $num3 =mysql_numrows($result3);
   $tot_cred =0;
   $i3 =0;
...
//------
 ...
 $query3 = "SELECT * FROM glaccountsf WHERE type like '%EQUITY%' ORDER BY account_name"; 	 
   $result3 = mysql_query($query3);
   $num3 =mysql_numrows($result3);
   $tot_cred =0;
   $i3 =0;
   echo"<table width ='100%'><tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>EQUITY </th><th width ='150' bgcolor ='black' align='right'><font color ='white'></th><th width ='150' bgcolor ='black' align='right'><font color ='white'></th></tr>";
...
while ($i3 < $num3){
   ...
   $income =number_format($tot_cred);
   $long_liab2 = number_format($long_liab);
   echo"<tr><td bgcolor ='black' align ='left' width ='300'><font color ='white'>EQUITY</td><td align ='right' bgcolor ='black'><font color ='white'></td><td bgcolor ='black' align ='right' ><font color ='white'>$long_liab2</td></tr></font>";
  



$total = $long_liab+$current_liab;
$all_liabilities = $total;
$total2 = number_format($total);
$owners_equity = $all_assets -$all_liabilities;
$all2 =  $owners_equity + $all_liabilities;
$all3 = number_format($all2);
$owners_equity1 =number_format($owners_equity);
echo"<tr><td bgcolor ='black' align ='left' width ='300'><font color ='white'>RETAINED EARNINGS</td><td align ='right' bgcolor ='black'><font color ='white'></td><td bgcolor ='black' align ='right' ><font color ='white'>$owners_equity1</td></tr></font>";
echo"<tr><td bgcolor ='black' align ='left'><font color ='white'>TOTAL LIABILITIES AND EQUITIES</td><td align ='right' bgcolor ='black'><font color ='white'>$all3</td><td bgcolor ='black' align ='right' ><font color ='white'></td></tr></font>";
