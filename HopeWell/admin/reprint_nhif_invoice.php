...
$finalise ='No';
  ...
  //  $bed_rate1     = mysql_result($result,$i,"bed_rate");  
...
if ($mm <0){
   $days = 0;
     ...
     // echo"<table width ='100%' border ='0' margin='0'><td align ='left'><img //src='king_david_hospital1a.jpg' alt='statement' width ='915'></td//></table>";      
      ...
      //if ($finalise=='Yes'){     
         echo"<tr><td align ='left' width ='50%'><b><u>PATIENTS NAME</u></b></td><td width ='20%' align ='right'><b>Invoice No:</b></td><td align 
      ='right' width ='20%'>";
         echo $invoice_no;
      echo"</td></tr>";
      echo"<tr><td align ='left' width ='50%'>$name</td><td width ='20%' align ='right'><b>Invoice Date:</b></td><td align ='right' width ='20%'>$mydate</td>  
      </tr>";
      echo"<tr><td align ='left' width ='50%'></td><td width ='20%' align ='right'><b>File No:</b></td><td align ='right' width ='20%'>$adm_no   
      </td></tr>";
$sDate = date("d-m-y",$adm_date);
$dDate = date("d-m-y",$disch_date);

    $inv_dis_date = $mydis_date;
    
      echo"<tr><td align ='left' width ='50%'><b>Paying A/c</b><br>$companys</td>";
      if ($inv_dis_date=='0000-00-00'){
          //
      }else{
      echo"<td width ='20%' align ='right'><b>Admited Date:</b></td><td align ='right' width ='20%'>$myadm_date</td></tr>";
      }
      if ($inv_dis_date=='0000-00-00'){
          //
      }else{
      echo"<tr><td width ='50%' align ='left'></td><td width ='20%' align ='right'><b>Discharge Date:</b></td><td align ='right' width ='20%'>";
          echo $inv_dis_date;
      }
...
//echo"Patient's Sign.____________________________________________<br><br>";
...
//                  $tot = $tot +$update2;
      ...
      echo'<br><br><br>';
         ...
         $ket =1500-$rate;
              ...
              echo"<table border ='0'><td width ='800' align='right'><b>PACKAGE </b></td><td width ='75' align ='right'><b>$ket</td></table>";
              
              
              echo"<table border ='0'><td width ='800' align='right'><b>INSURANCE TO PAY </b></td><td width ='75' align ='right'><b><u>Ksh 1500</u></td></table>";
