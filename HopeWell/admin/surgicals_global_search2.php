...
define ("DB_USER", "newhmisc"); // set database user
define ("DB_PASS","v9p0CnfH60"); // set database password
define ("DB_NAME","newhmisc_kingdavid"); // set database name
...
$query = 'SELECT description, search_name FROM stockfile WHERE description LIKE "%'.$user_input.'%" and sell_price >0 and location="MAIN STORE"';
