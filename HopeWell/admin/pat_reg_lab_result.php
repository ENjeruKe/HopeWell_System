...
if ($payer=''){
   $sql="SELECT * FROM  auto_transact WHERE invoice_no ='$ref_nos' and location='Lab'";
}else{
   $sql="SELECT * FROM  auto_transact_inv WHERE invoice_no ='$ref_nos' and location='Lab'";
}
...
<form action ="pat_reg_lab_result.php" method ="GET">
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      echo"<td width ='10'><a href=javascript:popcontact2('view_labresult2.php?accounts3=$aa')>$codes</a></td>";      
      echo"<td width ='200' align ='left'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
