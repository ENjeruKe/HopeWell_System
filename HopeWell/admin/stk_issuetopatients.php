...
if (isset($_GET['save_cancel'])){
   ...
   while ($i < $num)
      ...
      if ($issue=='Prescription'){
         ...
         $query4= "INSERT INTO st_trans_long VALUES('$long_ref_no','$location1','$desc','$patient', '$qty_s','ISP','$date','ADMIN','$rate','$total','$ref_no','$adm_no','$qty_s')";
...
'-$qty_s','ISP','$date','ADMIN','$rate','$total','$ref_no','$adm_no','','','','','')";
      ...
      VALUES('$adm_no','$patient','$date','$ref_no','$desc','DB','$rates','$chargable','$gledger','DB',' ','ADMIN',' 
      ','$date','$qty_s','')";
...
<form action ="stk_issuetopatients.php" method ="GET">
<?php
...
<table><td><h2>Post Medication | Issue to Patients</h2></td><td width ='450' align ='right'><p align ='right'><img src='images/retreat.jpg' alt='statement' height='60' width='150'></p></td></table>
...
echo"<table bgcolor ='red' border = '0' border color = 'black' width ='100%'><th width ='400' align ='left'>Item Description</th><th width ='100'>Price</th><th width ='120'>Qty</th><th width ='120'>Total</th><th width ='100'>Action</th></th></table>";
 ...
 while ($row=mysql_fetch_array($hasil)) 
    ...
    if ($qty > 0){
      ...
      $aa8=$row['id'];        
if ($qty <>0){
echo"<td width ='100' align ='right'><a href='stk_issuetopatients.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}else{
