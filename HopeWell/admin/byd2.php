...
<?php
 ...
 if (isset($_GET['print'])){
   ...
   echo"<h4> DRUG DISPENSION SUMMARY REPORT <img src='space.jpg' style='width:20px;height:2px;'>"."Dated from: ".$date1."<img src='space.jpg' style='width:20px;height:2px;'>"."To :".$date2;
echo"</h4>";
...
<table width ='100%'>
<tr>
<th bgcolor ='black' width ='50%'><font color ='white'>Drugs Name</th>
...
<th bgcolor ='black' width ='50%'><font color ='white'>Total Drugs Dispenced</th>
</tr>

<?php

$query = "SELECT description FROM st_trans WHERE date >='$date1' AND date <= '$date2' and location='DRUGS' GROUP BY description"; 	 
$result = mysql_query($query) or die(mysql_error());
...
//echo 'Test'.$test;
    $SQL ="select * FROM st_trans WHERE description ='$test' and date >='$date1' AND date <= '$date2' and location ='DRUGS' ORDER BY date" ;   
       $hasil=mysql_query($SQL, $connect);
       $id = 0;
       $nRecord = 1;
       $No = $nRecord;
    ...
    while ($row=mysql_fetch_array($hasil)) {
     ...
     //  echo "<td align ='right' width ='100'>" . number_format($row['qty']*-1) . "</td>";
     ...
     // echo"<hr>";
      ...
      echo "<b>$aa5</b>";      
      echo"</td>";          
      echo"<td width ='50%' align ='center'><b>$tot_bill2</b></td>";      
      echo"</tr>"; 
echo"<hr>";  
      //echo"</font>";
      echo"</table>";
...
<div class="w3-container w3-teal">
  <h1><font color ='green'> DRUG DISPENSION SUMMARY REPORT </font></h1>
</div>
...
<?php
  echo"<br>";
  echo"<form action ='byd2.php' method ='GET'>";
...
<div class="w3-container w3-teal">
  <p>Developed by Paltech System Consultants | E-mail: info@paltechsystemsconsultants.co.ke</p>
</div>
</body>
</head>
<script language="JavaScript" src="popups/pop-up.js"></script>
