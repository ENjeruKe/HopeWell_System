...
if (isset($_GET['search'])){
   ...
   if ($search_by =='Name'){
     $query = "select * FROM  dischargef WHERE patients_name LIKE '%$search%' ORDER BY patients_name,adm_date desc" ;
     $SQL   = "select * FROM  dischargef WHERE patients_name LIKE '%$search%' ORDER BY patients_name,adm_date desc" ;
   }
   if ($search_by =='Date'){
     $query = "select * FROM  dischargef WHERE adm_date = '$search' ORDER BY patients_name,adm_date desc" ;
     $SQL   = "select * FROM  dischargef WHERE adm_date = '$search' ORDER BY patients_name,adm_date desc" ;
   }

 }else{
   $query= "SELECT * FROM dischargef ORDER BY patients_name,adm_date DESC" or die(mysql_error());
   $SQL  = "SELECT * FROM dischargef ORDER BY patients_name,adm_date ORDER BY name DESC" or die(mysql_error());
}
...
echo"<tr><th width ='10'>IP Number</th><th>Patients Name</th><th>Age</th><th>Sex</th><th>Adm.Date</th><th>Dis.Date</th><th>Pay Account</th></tr>";
...
//while ($i < $num)
      {         
      $id      = mysql_result($result,$i,"id_no");  
      ...
      echo"</td>";
      echo"<td width ='300' align ='left'><a href='patients_edit_discharge_summary.php?accounts3=$bb&accounts=$aa&ref_no=$aa2'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
      ...
      //echo"$doctor";
      //echo"</td>"; 
      //echo"<td width ='100' align ='right'>$height</td>";
