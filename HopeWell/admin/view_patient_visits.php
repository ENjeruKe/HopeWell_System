...
echo"<textarea rows='10' cols='70' name='textarea' readonly>$textarea</textarea>";
}else{
echo"<textarea rows='10' cols='70' name='textarea' readonly></textarea>";
}
