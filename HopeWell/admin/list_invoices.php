...
if (isset($_GET['print'])){
   ...
   $query= "SELECT * FROM hdnotef WHERE date >='$from_date' AND date <= '$to_date' ORDER BY date" or die(mysql_error());
   $SQL  = "SELECT * FROM hdnotef WHERE date >='$from_date' AND date <= '$to_date' ORDER BY date" or die(mysql_error());
   $result =mysql_query($query) or die(mysql_error());
   $num =mysql_numrows($result) or die(mysql_error());
   $tot =0;
   $i = 0;
...
<form action ="list_invoices.php" method ="GET">
<table>
...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM hdnotef where date ='$mdate' ORDER BY patients_name" or die(mysql_error());
   $SQL  = "SELECT * FROM hdnotef where date ='$mdate' ORDER BY patients_name" or die(mysql_error());
}
