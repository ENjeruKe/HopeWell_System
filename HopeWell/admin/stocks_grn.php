...
if (isset($_GET['save_cancel'])){
   ...
   while ($i3 < $num3)
     ...
     while ($i < $num)
      ...
      $query4= "INSERT INTO st_trans VALUES('','$location1','$desc','$desc2','$qty_s','GRN','$date','ADMIN','$rate','$total','$inv_no','$supplier','$vat','$disc','$tot_vat','$tot_disc','$net_total')";
...
echo"<th width ='5%'  bgcolor='blue' align ='right'><font color='white'><h4>Action</h4></font></th></table>";
 ...
 while ($row=mysql_fetch_array($hasil)) 
      ...
      if ($desc > ' '){
         ...
         echo"<td width ='35%'><input type='text' id ='s_desc_three' size ='100' name='s_desc_three' value='$desc'></td>";
      }else{
         echo"<tr border ='2' bordercolor='black'>";
...
//</td>";
      ...
      $aa8=$row['id'];        
if ($aa8<>'1'){
echo"<td width ='90' align ='right'><a href='stocks_grn.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}
