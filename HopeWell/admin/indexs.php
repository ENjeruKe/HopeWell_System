                        ...
                        <div id="login" class="animate form">
                            <form  action="login.php" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="password" name="password" required="required" type="password" placeholder="admin" /> 
                                </p>

<p>Clinic? 
<select id="company" name="company">
<option value="Wama">Wama</option>
</select>
                                </p>
...
?>
                        <div id="register" class="animate form">
                            <form  action="login.php" autocomplete="on" method ="GET"> 
                                <h1> Sign up </h1> 
                                <p> 
