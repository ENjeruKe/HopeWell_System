...
echo"<td width ='15%' bgcolor ='red' align ='center'><ahref=javascript:popcontact3('admit_patients.php?accounts3=$ref_nos&accounts=$adm_no')><b><font color ='white'><b>Admit Patient</font></b></a></td><td width ='15%' bgcolor ='blue'  align ='center'><a href=javascript:popcontact3('discharge_now.php?accounts3=$ref_nos&accounts=$adm_no')><font color ='white'><b>Discharge</font></b></a></td></tr></table>";
...
echo"<a href=javascript:popcontact7('aller.php?accounts=$adm_no&accounts3=$name')><img src='aller.jpg' alt='scan' style='width:100%'></a></td><td width='20%'>";
...
echo"<a href=javascript:popcontact7('doc_window_23.php?accounts=$adm_no&accounts3=$ref_nos')><img src='folloup.jpg' alt='scan' style='width:100%'></a></td><table>";
//-----------------------------------------------------------
