...
<form action ="issuetopatients5.php" method ="GET">
<?php
 ...
 while ($row=mysql_fetch_array($hasil)) 
      ...
      if ($desc > ' '){
        ...
        ='$desc'></td>";
         ...
         $cdquery="SELECT search_name FROM stockfile";
         $cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());
...
echo"<td width ='100' align ='right'><a href='issuetopatients5.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
//echo"<td width ='10' align ='right'></td>";

//        echo"<a href='issuetopatients5.php?accounts5=$aa8'>Del";
