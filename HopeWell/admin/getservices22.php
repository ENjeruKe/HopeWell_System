...
<form action ="auto_search22.php" method ="GET">
...
while($row = mysqli_fetch_array($result)) {
   ...
   $_SESSION['drug']= $item;
if ($payer==''){
$query5= "INSERT INTO auto_transact_disch VALUES('','$short','$q2','$price','1','$price','$name','$date','$adm_no','','$ref_no','')";
}else{
$query5= "INSERT INTO auto_transact_INV_disch VALUES('','$short','$q2','$price','1','$price','$name','$date','$adm_no','','$ref_no','')";
}
