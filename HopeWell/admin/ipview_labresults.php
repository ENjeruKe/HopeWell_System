...
﻿<?php
 ...
 if (isset($_GET['accounts3'])){
    ...
    $adm_date = $_GET['accounts'];

   $SQL= "SELECT * FROM medicalfile where adm_no ='$ref_no' and date = '$adm_date'" or die(mysql_error());
   $hasil=mysql_query($SQL, $connect);

   $query= "SELECT * FROM medicalfile where adm_no ='$ref_no' and date = '$adm_date'" or die(mysql_error());
...
echo"<table width ='100%'><tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>Test Requested & Results</th></tr>";
if ($test1<>''){
   echo"<tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>$test1</th></tr>";
   echo"<tr><td width ='700' align ='left'><textarea rows='10' cols='120' style='border:dotted 1px orange;'>$test1_results</textarea></td></tr>";
}
if ($test2<>''){
//echo"<tr><td width ='150' align ='left'>$test2</td><td width ='550' align ='left'><textarea rows='20' cols='100' style='border:dotted 1px //orange;'>$test2_results</textarea></td></tr>";
   echo"<tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>$test2</th></tr>";
   echo"<tr><td width ='700' align ='left'><textarea rows='10' cols='120' style='border:dotted 1px orange;'>$test2_results</textarea></td></tr>";

}
if ($test3<>''){
//echo"<tr><td width ='150' align ='left'>$test3</td><td width ='550' align ='left'><texarea rows='20' cols='100' style='border:dotted 1px //orange;'>$test3_results</textarea></td></tr>";
   echo"<tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>$test3</th></tr>";
   echo"<tr><td width ='700' align ='left'><textarea rows='10' cols='120' style='border:dotted 1px orange;'>$test3_results</textarea></td></tr>";

}
if ($test4<>''){
   //echo"<tr><td width ='150' align ='left'>$test4</td><td width ='550' align ='left' rows='20' cols='100' style='border:dotted 1px //orange;'>$test4_results</td></tr>";
   echo"<tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>$test4</th></tr>";
   echo"<tr><td width ='700' align ='left'><textarea rows='10' cols='120' style='border:dotted 1px orange;'>$test4_results</textarea></td></tr>";

}
if ($test5<>''){
//echo"<tr><td width ='150' align ='left'>$test5</td><td width ='550' align ='left' rows='20' cols='100' style='border:dotted 1px //orange;'>$test5_results</td></tr>";
   echo"<tr><th width ='20' bgcolor ='black' align ='left'><font color ='white'>$test5</th></tr>";
   echo"<tr><td width ='700' align ='left'><textarea rows='10' cols='120' style='border:dotted 1px orange;'>$test5_results</textarea></td></tr>";

}
echo"</table>";
echo"<hr><br><br>";
}
echo"Prepare by:_______________________________________________ <br><br>";
echo"Doctor:___________________________________________________<br><br>";
echo"Date reported:".$date."<br><br>";
echo"Print Date:".$today."<br><br>";
