...
if (isset($_GET['accounts3']) OR isset($_GET['account3'])){    
   ...
   while ($i < $num3)
     {
      $ref_noz      = mysql_result($result3,$i,"ref_no");          
      $i++;
    }
}
...
echo"<tr><td width ='50'><b>Visit. No:</b></td><td width='50' align='left'><input type='text' id ='ref_no' name='ref_no' value='$ref_noz' size='10' readonly></td></tr>";
...
echo"<tr><td width ='100'><b>Pulse</td><td width='50' align='left'><input type='text' id ='height' name='pulse'  
 value='$pulse' size='10' ></td></tr>";


echo"<tr><td width ='100'><b>Height</td><td width='50' align='left'><input type='text' id ='height' name='height'  
 value='$height' size='10' ></td></tr>";


echo"<tr><td width ='100'><b>BMI</td><td width='50' align='left'><input type='text' id ='height' name='bmi'  
 value='$bmi' size='10' ></td></tr>";
 
 
echo"<tr><td width ='100'><b>SPO 2</td><td width='50' align='left'><input type='text' id ='height' name='spo'  
 value='$spo' size='10' ></td></tr>";
