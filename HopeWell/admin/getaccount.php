...
$sql="SELECT * FROM glaccountsf WHERE account_name = '".$q2."'";
...
echo"<form action ='post_journal.php' method ='GET'>";
 echo"<table width ='100%' border = '2'><td width ='50%'><input type='text' id ='s_desc_three' name='s_desc_three' size ='60' value ='$q2'</td><td width ='50' required></td>";
 echo"<td><input type='text' id ='no_three' name='no_three' size='10' 
 onchange='function3()' required></td>";
 echo"<td width ='15%'><input type='text' id ='result_three' name='result_three' size='10' required></td>";
