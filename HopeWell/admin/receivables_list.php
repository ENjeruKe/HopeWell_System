...
if (isset($_GET['print'])){
   ...
   echo"</table><br>";
   echo"<h4><u>Account Receivables Listing</u></h4><img src='space.jpg' style='width:20px;height:2px;'>";
...
$query= "SELECT * FROM debtorsfile where account_name<>''" or die(mysql_error());
$result =mysql_query($query) or die(mysql_error());
$num =mysql_numrows($result) or die(mysql_error());
...
$SQL= "SELECT * FROM debtorsfile where account_name<>''" or die(mysql_error());
$hasil=mysql_query($SQL, $connect);
$id = 0;
$nRecord = 1;
$No = $nRecord;
...
echo"</tr>";
      ...
      echo"<td width ='100'><h4>$tot</h4></td>";
      echo"</tr>";   
      echo"</table>";
}
?>
