...
<div class="w3-container w3-teal">
  <h1>Client Details | <font color ='red'>HMIS</font></h1>
</div>
...
<!--div id="section"-->
<OBJECT data="patient_register.php" type="text/html" style="margin: 0%; width: 100%; height: 450px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
