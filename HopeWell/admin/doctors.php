...
echo"<td>".$row['telephone']."</td><td>".$row['date']."</td><td>".$row['status']."</td><td>".$row['payer']."</td><td>".$row['sex']."</td><td>".$row['image_id']."</td></tr>";
  ...
  $query=mysql_query("select * from medicalfile where date='$date' and (status ='To Doctor' or status ='To Doctor' or status ='To WBC' or status ='To Antenatal' or status ='To Dental' or status ='To Nutriton' or status ='To Dental')");
