...
if (isset($_GET['save_cancel'])){
   ...
   while ($i < $num)
      ...
      //----------------------
      $query5= "INSERT INTO gltransf VALUES('','$date','$desc','$ref_no','JV','$narration','$amount','admin','$codes')";
...
<form action ="post_journal.php" method ="GET">
<?php
...
/////////////////////////////////
echo"<table><tr><td width ='100'><b>Vourcher No.</b></td><td width='50' align='left'><input type='text' id ='jv_no' name='jv_no' size='10' value ='$next_jv'></td></tr><tr><td width ='100'><b>JV. Date:</b></td><td width='50' align='left'><input type='text' id ='date' name='date' size='10' value ='$mydate'></td></tr><tr><td width ='50'><b>Narration</b></td><td width='50' align='left'><input type='text' id ='narration' name='narration' size='70' value ='Journal Voucher'></td></tr>";
echo"</table>";
echo"<table bgcolor ='green' border = '0' border color = 'black' width='100%'><font color='white'><th width ='50%' align ='left'>Account Description</th><th width ='15%'></th><th width ='10%'>Debit</th><th width ='10%'>Credit</th><th width ='5%'>Action</th></th></font>";
 ...
 while ($row=mysql_fetch_array($hasil)) 
    ...
    ='$total' ></td>";
      ...
      $aa8=$row['id'];        
if ($desc > ' '){
echo"<td width ='5%' align ='right'><a href='post_journal.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}else{
...
echo"<img src='ico/black.jpg' style='width:950px;height:1px;'>";
