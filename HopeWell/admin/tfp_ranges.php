...
echo "</td><td><input type='text' id ='line1' name='line1' size='5' value =''></td><td><input type='text' id ='line1_1' name='line1_1' size='5' value ='0.8 - 2.0' readonly></td><td>pg/ml</td></tr>";


echo "<tr><td width ='25%' bgcolor ='green'><font color ='white'>FT4 - ng/dl (FREE)</td>";
    echo "</td><td><input type='text' name='line2' size='5' value =''></td><td><input type='text' id ='line2_1' name='line2_1' size='5' value ='0.8 - 1.9' readonly></td><td>mg/dl</td></tr>";

    echo "<tr><td width ='25%' bgcolor ='green'><font color ='white'>TSH - uIU.ml</td>";
    echo "</td><td><input type='text' name='line3' size='5' value =''></td><td><input type='text' name='line3_1' size='5' value ='0.4 - 5.0' readonly></td><td>uIU/mL</td></tr>";
