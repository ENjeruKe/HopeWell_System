...
while ($row=mysql_fetch_array($hasil)) 
   ...
   echo"<tr><td align ='left'><b>$address3</b></td></tr>";
   echo"</table><br>";
   echo"<b>Doctors Account</b><img src='space.jpg' style='width:20px;height:2px;'>";
   //echo"<img src='ico/black.jpg' style='width:500px;height:1px;'><br>";
...
$today = date('y/m/d');
$query= "SELECT * FROM doctorsfile" or die(mysql_error());
$result =mysql_query($query) or die(mysql_error());
$num =mysql_numrows($result) or die(mysql_error());
$tot =0;
$i = 0;
...
echo"<table class='altrowstable' id='alternatecolor'>";
$SQL= "SELECT * FROM doctorsfile" or die(mysql_error());
$hasil=mysql_query($SQL, $connect);
$id = 0;
$nRecord = 1;
$No = $nRecord;
