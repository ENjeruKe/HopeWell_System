...
if (isset($_GET['search'])){
   // echo "1";
   $search = $_GET['search'];
   $SQL    = "select * FROM gltransf WHERE type='PAY' and account_name = '$acc_name' and date >='$date1' and date <='$date2' ORDER BY date"; 
   $query  = "select * FROM gltransf WHERE type='PAY' and account_name = '$acc_name' and date >='$date1' and date <='$date2' ORDER BY date"; 
 }else{
    // echo "2";
...
if (isset($_GET['search'])){
   $search = $_GET['search'];
   $SQL = "select * FROM gltransf WHERE type='PAY' and account_name = '$acc_name' AND date >='$date1' AND date <= '$date2'
ORDER BY date"; 
 }else{
...
<?php
   ...
   echo"<form action ='gl_payments_bydate.php' method ='GET'>";
