...
if ($payer==''){
$sql="SELECT * FROM  auto_transact WHERE invoice_no ='$ref_no' and location ='Pro' and location <>''";
}else{
$sql="SELECT * FROM  auto_transact_inv WHERE invoice_no ='$ref_no' and location ='Pro' and location <>''";
}
$result = mysql_query($sql);
$found ='No';
...
if ($edit=='' or $edit=='no'){
    ...
    die();
       ...
       echo "<td align ='center'>" ."<a href='charged_tests3.php?accountss=$line&accounts33=$price&account3=$id')>"."Delete"."</a>" . "</td>";
}
    }
    echo "</tr>";
}
