...
<div class="w3-container w3-teal">
  <h1>Medical Form | <font color ='yellow'>In-Patient Doctors Page</font></h1>
</div>
...
<!--div id="section"-->
<OBJECT data="ip_register_doctor.php" type="text/html" style="margin: 0%; width: 100%; height: 800px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
