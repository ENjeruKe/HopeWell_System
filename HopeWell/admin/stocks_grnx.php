...
if (isset($_GET['save_cancel'])){
   ...
   while ($i3 < $num3)
     ...
     $query = "select * FROM stock_transferx WHERE description <>''" ;
     ...
     while ($i < $num)
      ...
      $batch    = mysql_result($result,$i,"batch_no"); 
      ...
      $query3= "UPDATE stockfile SET qty ='$qty',cost_price='$rate' WHERE id ='$search_id'";
      $result3 =mysql_query($query3);

      $query4= "INSERT INTO st_trans VALUES('','$location1','$desc','$desc2','$qty_s','GRN','$date','$username','$rate','$total','$inv_no','$supplier','$vat','$disc','$tot_vat','$tot_disc','$net_total')";
      $result4 =mysql_query($query4);
      
      $query4= "INSERT INTO st_butch_expiryf VALUES('','$location1','$desc','$desc2','$qty_s','GRN','$date','$username','$rate','$total','$inv_no','$supplier','$vat','$disc','$batch','$expiry','$net_total')";
      $result4 =mysql_query($query4);
   ...
   //----------------------
   $query5= "INSERT INTO gltransf    VALUES('','$date','$debit_account','$ref_no','GRN','$desc','$orig_amt','admin','$company_identity')";
   $result5 =mysql_query($query5);

   if ($tot_vats>0){
      $query5= "INSERT INTO gltransf       VALUES('','$date','$vat_control','$ref_no','GRN','$desc','-$tot_vats','admin','$company_identity')";
      $result5 =mysql_query($query5);
...
echo"<table width ='100%'><tr><th width ='200' bgcolor ='black' align ='left'><font color ='white'>Item Description</th><th width ='50' bgcolor ='black' align='right'><font color ='white'>@cost</th><th width ='50' bgcolor ='black' align='right'><font color ='white'>Qty</th><th width ='50' bgcolor ='black' align='right'><font color ='white'>Total</th><th width ='50' bgcolor ='black' align='right'><font color ='white'>Discount</th><th width ='50' bgcolor ='black' align='right'><font color ='white'>Net Total</th></tr>";
     $query = "update stock_transferx set total =gl_account-tot_disc+tot_vat WHERE description <>''" ;
     $result =mysql_query($query) or die(mysql_error());
...
echo"Official Stamp";
   ...
   //-----------------------------
   $query3 = "DELETE FROM stock_transferx WHERE qty > 0";
   $result3 =mysql_query($query3) or die(mysql_error());
   die();
}
...
if (isset($_GET['accounts5'])){      
   ...
   $query3 = "DELETE FROM stock_transferx WHERE id ='$record'";
   $result3 =mysql_query($query3) or die(mysql_error());
...
// sql to create table
$sql = "CREATE TABLE stock_transferx (
...
echo "here...1";
   $query= "CREATE TEMPORARY TABLE stock_transferx IF NOT EXISTS stock_transferx (location varchar(100) NOT NULL,
...
echo "here...2";
   ...
   $query9= "INSERT INTO stock_transferx  VALUES('','$location','$description','$amount','$qty','$vat','$total','$search_id','$disc2','$vats','$disc',
'$net_total','$batch','$expiry')";
   $result9 =mysql_query($query9);
   $myDate =date('y-m-d');

echo "here...3";
   $query3 = "DELETE FROM stock_transferx WHERE description <>'' and qty = 0";
   $result3 =mysql_query($query3) or die(mysql_error());
...
function showUser(str) {    
    if (str == "") {
        ...
        xmlhttp.open("GET","getpricegrnx.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<form action ="stocks_grnx.php" method ="GET">
<?php
...
echo"<th width ='25%' align ='left' bgcolor='blue'><font color='white'><h4>Item Description</h4></font></th>";
echo"<th width ='5%' bgcolor='blue'><font color='white'><h4>@Cost</h4></font></th>";
echo"<th width ='5%' bgcolor='blue'><font color='white'><h4>Qty</h4></font></th>";
echo"<th width ='5%' bgcolor='blue'><font color='white'><h4>Total</h4></font></th>";
echo"<th width ='5%' bgcolor='blue'><font color='white'><h4>Batch #</h4></font></th>";
echo"<th width ='10%' bgcolor='blue'><font color='white'><h4>Expiry</h4></font></th>";
echo"<th width ='5%'  bgcolor='blue' align ='right'><font color='white'><h4>Action</h4></font></th></table>";
 ...
 $query= "SELECT * FROM stock_transferx " or die(mysql_error());
 $result =mysql_query($query) or die(mysql_error());
 $num =mysql_numrows($result) or die(mysql_error());
 $tot =0;
 $i = 0;
 ...
 $company_identity =$_SESSION['company'];
 $SQL = "select * FROM stock_transferx" ;
 $hasil=mysql_query($SQL, $connect);
 $id = 0;
 $nRecord = 1;
 $No = $nRecord;
 ...
 while ($row=mysql_fetch_array($hasil)) 
      ...
      if ($desc > ' '){
         ...
         echo"<td width ='25%'><input type='text' id ='s_desc_three' size ='100' name='s_desc_three' value='$desc'></td>";
      }else{
         echo"<tr border ='2' bordercolor='black'>";
         echo"<td align ='left' width ='10%'><input type='text' name='search_id1'  id ='search_id1' value='XX' size ='5' readonly></td>";
    ...
    if ($qty > 0){
        echo"<td width ='5%'><input type='text' id ='s_amount_three' name='amount_three' size='10' value 
        ='$price' readonly></td>";
        echo"<td width ='5%'><input type='text' id ='s_no_three' name='s_no_three' size='5' value ='$qty' readonly></td>";
        echo"<td width ='10%'><input type='text' id ='s_result_three' name='s_result_three' size='15' value 
        ='$total' readonly></td>";
        echo"<td width ='5%'><input type='text' id ='butch' name='butch' size='10' value ='$batch' readonly></td>";
        echo"<td width ='5%'><input type='text' id ='expiry' name='expiry' size='7' value ='$expiry' readonly></td>";
    }else{
...
//</td>";
      ...
      $aa8=$row['id'];        
if ($aa8<>'1'){
echo"<td width ='90' align ='right'><a href='stocks_grnx.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}
...
echo"<tr><td width ='100'><b>Invoice No.</b></td><td><input type='text' name='inv_no' size ='10' required></td><td width ='100' align ='right'></td><td width ='100' align ='right'><b>Delivery No.</b></td><td width ='100' align ='right' required><input type='text' name='deliv_no' size ='10'></td><td></td><td align ='right' width ='200'><b>Tot-VAT:</b></td><td width ='10' align ='right'><b><input type='text' size ='10' name='tot_vat' id='tot_vat' value='$tot_vats'readonly></b></td></tr>";
...
if (isset($_GET['save_cancel77'])){
   ...
   $query = "select * FROM stock_transferx" ;
   $result =mysql_query($query) or die(mysql_error());
   $id = 0;
   $nRecord = 1;
   $No = $nRecord;
   ...
   while ($i < $num)
      ...
      $query4= "INSERT INTO st_butch_expiryf VALUES('','$codes','$desc','','$qty_s','Goods Received.','$date','ADMIN','$rate','$total','$ref_no','$ref_no','$vat','$disc','$batch','$expiry','$net_total')";
      $result4 =mysql_query($query4);
