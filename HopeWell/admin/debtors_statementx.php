...
function showUser(str) {    
    if (str == "") {
        ...
        xmlhttp.open("GET","getdebtor4x.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
/////////////////////////////////
echo"<table>";
//echo"<tr><td width ='100'><b>Remitance No.</b></td><td width='50' align='left'><input type='text' id ='jv_no' name='jv_no' size='10' value ='$next_jv'></td></tr><tr><td width ='100'><b>Pay Date:</b></td><td width='50' align='left'><input type='text' id ='date' name='date' size='10' value ='$mydate'></td></tr>";
