...
$query9= "INSERT INTO hosp_clinic VALUES ('','$adm_no','$customer','$sex','$mdate','$ref_nos','$line1',
...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM medicalfile where status ='To Antenatal' and date ='$mdate' and type='Outpatient' ORDER BY dose7" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where status ='To Antenatal' and date ='$mdate' and type='Outpatient' ORDER BY dose7" or die(mysql_error());
}
