...
//$query5= "INSERT INTO htransf //VALUES('$adm_no','$customer','$today','$next_ref','$service','DB','$price','$today','$gledger_acc','IP/OPD','$next_ref','$username','','$today','1','$loca//tion')";
// $result5 =mysql_query($query5);
...
$time = $_SESSION["log_date"];
 ...
 $query= "INSERT INTO medicalfile (location,adm_no,gl_account,date,age,name,sex,description,sell_price,type,status,ref_no,doctor,next_app,dose7) VALUES ('New','$adm_no','$payer','$today','$age','$customer','$sex','CONSULTATION FEE','$price','$pat_type','$status','$next_ref','$time','$time','$times')"; 
...
echo"<table width ='100%' border ='0'><br><br>";

echo"<tr><td width ='50'><b><font color='green'>First Name:</font></b></td><td width='50' align='left'><input type='text' id ='name1' name='name1' size='30' class='field-style field-split align-left' required></td><td></td><td></td></tr>";
...
echo"</select></td>";
echo"<td width ='100'><font color='green'></td><td width='50' align='left'></td></tr>";
