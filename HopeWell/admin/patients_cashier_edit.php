...
//and location ='DRUGS' 
      ...
      $i2++;
         ...
         if ($available == 'No'){
            if ($payer==''){
               $query2 = "select * FROM auto_transact where invoice_no ='$ref_nos' and selected='pay'" ;
            }else{
               $query2 = "select * FROM auto_transact_inv where invoice_no ='$ref_nos' and selected='pay'" ;
            }
            //$query2 = "select * FROM auto_transact where line_no ='$adm_no' and date ='$date'" ;
            $result2 =mysql_query($query2) or die(mysql_error());
            $id = 0;
...
<form action ="patients_cashier_edit.php" method ="GET">
...
//}else{
   echo"<h3><font color ='red'><a href ='patients_cashier_edit.php?accounts3=$adm_no&accounts=$id_no&accepted=$id_no'>Get Totals</a></h3></font>";
//}
echo"</th></table>";
$total =0;
...
if ($payer==''){
 $sql="SELECT * FROM  auto_transact WHERE invoice_no = '$ref_nos' and date ='$date' and description <>'' and selected='pay'";
   //and location='DRUGS' 
}else{
 $sql="SELECT * FROM  auto_transact_inv WHERE invoice_no = '$ref_nos' and date ='$date' and description <>'' and selected='pay'";
}
...
if ($found =='No'){
    echo"<font color ='red'>No Bill to pay...............</font>";
    die();
}
...
if ($pay_now =='Yes'){
   ...
   $result =mysql_query($query) or die(mysql_error());   
echo"<table width ='100%' border ='0'><td width ='20%' align ='right'><h2><font color ='red'>Total:</font></td><td width ='20%' align ='right'><h2><font color ='blue'>$totals</font></h2></td><td width ='20%' align ='center'>";
echo"<a href=javascript:popcontact7('post_receipts2.php?accounts=$ref_nos&accounts3=$adm_no&accounts4=$totals')><h2>Save</h2></a>";
echo"</td></table>";
...
echo"<option value='To Clinic'>To Clinic</option>";
