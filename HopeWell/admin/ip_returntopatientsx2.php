...
<form action ="ip_returntopatientsx2.php" method ="GET">
<?php
 ...
 //while ($row=mysql_fetch_array($hasil)) 
   while ($i7 < $num7)
    ...
    if ($qty > 0){
      ...
      //$aa8=$row['id'];        
if ($qty <>0){
echo"<td width ='10%' align ='right'><a href='ip_returntopatientsx2.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}else{
