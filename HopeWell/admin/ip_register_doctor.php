...
//if ($grand_total > 0){
   $query3= "UPDATE medicalfile SET test1='$test1',test1_qty='$test1_qty',test2='$test2',test2_qty='$test2_qty' ,test3='$test3',test3_qty='$test3_qty',test4='$test4',test4_qty='$test4_qty',test5='$test5',test5_qty='$test5_qty' WHERE ref_no = '$ref_nos'";
...
<form action ="ip_register_doctor.php" method ="GET">
...
echo $search;
   ...
   $query= "SELECT * FROM medicalfile where type='Inpatient'" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where type='Inpatient'" or die(mysql_error());
}
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      $ward = mysql_result($result,$i,"test1");
      $bed_no = mysql_result($result,$i,"test2");
      ...
      echo"$age";
      echo"</td>";      
      echo"<td width ='20'><a href=javascript:popcontact2('patients_reg_info.php?accounts3=$bb&accounts=$aa&ref_no=$aa2')>$rate</a>";      
