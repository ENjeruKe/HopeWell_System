...
'$ward','$bed_no','$status','$payer','$charge','$age','$sex',
...
if (isset($_GET['consfee'])){ 
   ...
   if ($payer==''){
      ...
      //--------------------------------------------------------
     $query5= "INSERT INTO auto_transact VALUES('','Hosp','$service','$price','1','$price','$customer',
'$today','$adm_no','','$hnext_ref','')";
     $result5 =mysql_query($query5);  
     }else{
      //$status ='';
     $query5= "INSERT INTO auto_transact_inv VALUES('','Hosp','$service','$price','1','$price','$customer',
'$today','$adm_no','','$hnext_ref','')";
     $result5 =mysql_query($query5);  
     }
...
<form action ="patients_reg_add22.php" method ="GET">
<?php
...
echo"<tr><td width ='50'><font color='green'><b>Patient:</b><font color ='yellow'>*</font></td><td width='50' align='left'><input type='text' id ='customer' name='customer' size='50' required></td><td></td><td></td></tr>";
...
echo"<select id='consfee' name='consfee'>";
$cdquery="SELECT name FROM revenuef where name like '%cons%' order by name";
$cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());
$query3 = "select * FROM suppliersfile order by account_name";
$result3 =mysql_query($query3) or die(mysql_error());
$num3 =mysql_numrows($result3) or die(mysql_error());
