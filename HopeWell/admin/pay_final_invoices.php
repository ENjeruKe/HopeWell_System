...
<!--p align ='center'><img src='access-denied.png' style='width:400px;height:400px;'></p>
<table width ='100%'><td width ='100%' align='center'><h1><font color ='green'>Safaricom</font></h1></td></table-->
...
if (isset($_GET['accounts3'])){    
   ...
   //Asign the receipt No.
   //---------------------
   $query3 = "select * FROM opt_hdnotef where invoice_no ='$adm_no'" ;
   $result3 =mysql_query($query3) or die(mysql_error());
   $num3 =mysql_numrows($result3) or die(mysql_error());
   $i3=0;
   while ($i3 < $num3)
     {
     $ref_no   = mysql_result($result3,$i3,"invoice_no");  
     $payer    = mysql_result($result3,$i3,"patients_name");  
     $amount   = mysql_result($result3,$i3,"inv_amount");  
     $i3++;
     }
...
if (isset($_GET['save_cancel'])){
   ...
   $tot_amt = $paid;
     ...
     //-------------------------------------------------
     $query5= "INSERT INTO receiptf VALUES('','$codes','Optical Balance','$payer','1','$tr_type','$date','$username','$paid','$paid','$ref_no','0','$adm_no','','$timew')";
   ...
   //----------------------
   $payer_info = $payer. 'Optical Balance';
   $query5= "INSERT INTO gltransf 
   VALUES('','$date','$debit_account','$ref_no','RC','$payer_info','$paid','$codes','$company_identity')";
   $result5 =mysql_query($query5);
   ...
   //--------------------------
   $payer_info = $payer. 'Optical Balance';
   $query5= "INSERT INTO gltransf VALUES('','$date','$credit_account','$ref_no','RC','$payer_info','-$paid','$codes','$company_identity')";
   $result5 =mysql_query($query5);


     $query  = "INSERT INTO dtransf VALUES('$payer','$date','$tr_type','$ref_no','$branch','RC','-$paid','-$paid','$username')";
     $result =mysql_query($query);

   $db_balance = $balance-$paid;
   $query2= "UPDATE opt_hdnotef SET inv_amount ='$db_balance' WHERE invoice_no ='$ref_no'";
   $result2 =mysql_query($query2);
...
<?php
   ...
   echo"<tr><td width ='400' align ='center'><h3>INVOICES SALE RECEIPT</h4></td><tr>";
 ...
 //---------Sawa up to this point------------------
   echo"<div><h4>Payer :<img src='space.jpg' style='width:20px;height:2px;'>$payer</h4><img src='space.jpg' style='width:40px;height:2px;'><b>Date:<img src='space.jpg' style='width:5px;height:2px;'>$date</b><br>";
echo"------------------------------------------------------------------------<b><br>";
...
if (isset($_GET['save_cancel3']))
   ...
   while ($i < $num)
      ...
      $query4= "INSERT INTO st_trans VALUES('$codes','$item_desc','Sales','-$qty_s','Stock Sales','$date','$username','$rate','$total','$ref_no','$adm_no')";
...
<form action ="pay_final_invoices.php" method ="GET">
<?php
...
echo"<tr><td width ='50'><b>Payer:</b></td><td width='50' align='left'><input type='text' id ='db_account' name='db_account' size='20' value ='$payer' readonly></td></tr>";
...
echo"<tr><td width ='50'><b>Amount Balance</b></td><td width='10' align='left'><input type='text' id ='amount1' name='amount1' size='10' value ='$amount' readonly></td></tr>";
echo"<tr><td width ='50'><b>Amount Paid</b></td><td width='10' align='left'><input type='text' id ='amount' name='amount' size='10' value ='$amount' required></td></tr>";
echo"</table><br>";
//removed from here
//-----------------
