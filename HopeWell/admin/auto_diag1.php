...
<tr><td><input id="dd_user_input2" type="text" size ='80' class="search_form3" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" value="Type your diagnosis here..." onchange="showUser(this.value)"
/></td></tr>

<tr><td><input id="dd_user_input4" type="text" size ='80' class="search_form4" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" value="Type your diagnosis here..." onchange="showUser(this.value)"
/></td></tr>

<tr><td><input id="dd_user_input5" type="text" size ='80' class="search_form5" onblur="if(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" value="Type your diagnosis here..." onchange="showUser(this.value)"
/></td></tr>
