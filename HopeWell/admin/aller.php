...
if (isset($_GET['add_cancels'])){
   ...
   //-------------------------
   $sql="SELECT * FROM stockfile WHERE description = '$drug' "; 
   ...
   $tt_price = $total*$price;
      ...
      //------------------------------------------------------
      if ($payer==''){
         $query5= "INSERT INTO auto_transact VALUES('','SURG','$drug','$price','$total','$tt_price','$name','$date','$adm_no','pay','$ref_no','')";
      }else{
      $query5= "INSERT INTO auto_transact_inv VALUES('','SURG','$drug','$price','$total','$tt_price','$name','$date','$adm_no','pay','$ref_no','')";
     }
   ...
   $cost = $total*
$query5= "INSERT INTO auto_transact_tmp VALUES('','SURG','$drug','1','1','','$info','$date','$adm_no','','$ref_no','')";
$result5 =mysql_query($query5);
...
echo '3';
require('surgicals_auto_serch2.php');
...
function showUser(str) {   
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","charge_servicesx.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
echo"<br><table>";
echo 'Ref:'.$ref_no;
echo"<td><a href='aller.php?Pharmacy=$ref_no&accounts3y=$adm_no'>To Pharmacy</a>|</td>";
echo"</table><br>";
