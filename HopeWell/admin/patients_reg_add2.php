...
if (isset($_GET['save_cancel'])){ 
   ...
   while ($i3 < $num3)
     ...
     if ($email=='STAFF-OP'){
        $query5= "INSERT INTO next_staffop VALUES('')";
        $result5 =mysql_query($query5);  
     ...
     if ($email=='STAFF-IP'){
        $query5= "INSERT INTO next_staffip VALUES('')";
        $result5 =mysql_query($query5);  
...
if (isset($_GET['consfee'])){ 
 ...
 $adm_date = date("Y-m-d H:i:s");
   ...
   $query51= "INSERT INTO appointmentf VALUES('','$customer','$telephone','$email','$doctor','$adm_date','',
'$ward','$bed_no','$status','$payer','$doc_type','$age','$sex',
...
$status ='To cash office';
   ...
   if ($payer==''){
      ...
      //--------------------------------------------------------
     $query52= "INSERT INTO auto_transact VALUES('','Hosp','$service','$price','1','$price','$customer','$today','$adm_no','pay','$hnext_ref','')";
     $result52 =mysql_query($query52);  
     }else{
    //  $status ='To Triage';
     $query53= "INSERT INTO auto_transact_inv VALUES('','Hosp','$service','$price','1','$price','$customer','$today','$adm_no','pay','$hnext_ref','')";
...
//here
$status ='To cash office';
 $query= "INSERT INTO medicalfile (location,adm_no,gl_account,date,age,name,sex,description,sell_price,type,status,ref_no,doctor,next_app,dose7,test1_qty,sign1) VALUES ('New','$adm_no','$payer','$today','$age','$customer','$sex','CONSULTATION FEE','$price','$pat_type','$status','$next_ref','$time','$time','$times','$subchief','$telephone')"; 
$result =mysql_query($query);

// $query= "INSERT INTO medicalfile (location,adm_no,gl_account,date,age,name,sex,description,sell_price,type,status,ref_no,doctor,next_app,dose7,test1_qty,sign1) VALUES ('','','','','','','','','','','','','','','','',$telephone)"; 
//$result =mysql_query($query);



 $query= "INSERT INTO newprescription (prescid,TransDate,Type,PatId,Patname,OPNo,StartTime) VALUES ('$next_ref','$today','NewPatient','$adm_no','$customer','$next_ref','$timew')"; 
$result =mysql_query($query);
...
<b>Out-Patient Register</b>
<form action ="patients_reg_add2.php" method ="GET" class="form-style-9">
...
echo"<tr><td width ='100'><font color='green'><b>ID No.</b><font color ='red'>*</font></td><td width='50' align='left'><input type='text' id ='id_no' name='id_no' size='20' required></td><td width ='100'><b>NHIF No.</td><td width='50' align='left'><input type='text' id ='nhif_no' name='nhif_no'  
  size='20' ></td></tr>";
...
echo"<option value='ANC'>ANC</option>";
echo"<option value='MAT'>MAT</option>";
echo"<option value='WBC'>WBC</option>";
echo"<option value='IP'>IP</option>";
echo"<option value='STAFF-OP'>STAFF-OP</option>";
echo"<option value='STAFF-IP'>STAFF-IP</option>";
...
$cdquery="SELECT name,gl_account FROM revenuef where gl_account <> '' order by name";
$cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());
$query3 = "select * FROM suppliersfile order by account_name";
$result3 =mysql_query($query3) or die(mysql_error());
$num3 =mysql_numrows($result3) or die(mysql_error());
...
echo"<tr><td width ='50'><font color='green'><b>Charge Consultation:</b></font></td><td width='50' align='left'><input type='checkbox' name='charge' id='charge' value ='charge' checked='checked' readonly></td><td></td><td></td></tr>";
...
echo"<tr><td width ='50'><font color='green'><b>Dental:</b></font></td><td width='50' align='left'><input type='checkbox' name='dental' id='dental' value ='bar'></td><td></td><td></td></tr></table>";
