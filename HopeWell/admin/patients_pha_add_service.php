...
require('auto_search_dd.php');



//Displaying items to be adjusted
$mydate = $_SESSION['mart_date'];
/////////////////////////////////
$_SESSION['payer'] = $payer;
...
//}else{
   echo"<h3><font color ='red'><a href ='patients_pha_add_service.php?accounts3=$adm_no&accounts=$id_no&accepted=$id_no'>Get Totals</a></h3></font>";
//}
echo"</th></table>";
$total =0;
...
//$query2="SELECT * FROM  auto_transact_inv WHERE line_no = //'$adm_no' and date ='$date' and location='DRUGS' and //description <>''";
...
echo"<a href=javascript:popcontact7('post_receipts.php?accounts=$ref_nos&accounts3=$adm_no&accounts4=$totals')><h2>Pay</h2></a></td></table>";
}
...
echo "<u>Diagnosis</u><br>";
echo $diag11.';'.$diag21.';'.$diag31;
echo"<br><hr>";
echo $notes;
...
<OBJECT data='auto_search2_dd.php' type='text/html' style='margin: 0; width: 600px; height: 200px; padding 0px; text-align:left;'></OBJECT>
