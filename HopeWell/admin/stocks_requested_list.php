...
if ($search==''){
$query  = "select * FROM st_requestf WHERE date >='$date1' and date <= '$date2' GROUP BY ref_no" ;
}else{
$query  = "select * FROM st_requestf WHERE location='$search' and date >='$date1' and date <= '$date2' ORDER BY ref_no" ;
}
...
echo"<th><h3>Stock Requested List</h3></th></tr>";
      ...
      echo"<font color ='white'>Requesting store</font>";
      echo"</td>";
      echo"<td width ='25%' align ='left' bgcolor ='black'>";      
      ...
      echo"</td>";
      echo"<td width ='10%' align ='left' bgcolor ='black'>";      
      echo"<font color ='white'>Issue store</font>";
      echo"</td>";
...
$SQL  = "select * FROM st_requestf WHERE location='$search' and date >='$date1' and date <= '$date2' GROUP BY ref_no" ;
}
...
while ($row=mysql_fetch_array($hasil)) 
     ...
     $adm_no   = mysql_result($result,$i,"adm_no");   
      ...
      echo"<a href=javascript:popcontact505('view_requests.php?invoice=$code&qtys=$qty')><font color ='red'>$code</font></a>";
      echo"</td>";
      echo"<td width ='10%' align ='left'>";      
      echo"$adm_no";
      echo"</td>";
...
die();
   ...
   echo"<form action ='stocks_requested_list.php' method ='GET'>";

   echo"<table><tr><td>Requested Store:</td><td>";
