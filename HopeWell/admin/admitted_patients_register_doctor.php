...
$query9= "UPDATE nurses  SET status='To Ward',line7='$line7',line8='$line8',line9='$line9',line10='$line10',line11='$line11',line12='$line12',line13='$line13',line14='$line14',line15='$line15',line16='$line16',line17='$line17',line18='$line18',line19='$line19',line20='$line20',line21='$line21',line22='$line22',line23='$line23',line24='$line24',line25='$line25',line26='$line26',line27='$line27',line28='$line28'
where adm_no ='$adm_no' and name='$name'"; 
...
$query9= "UPDATE nurses  SET line29='$line29',line30='$line30',line31='$line31',line32='$line32',line33='$line33',line34='$line34',line35='$line35',line36='$line36',line37='$line37',line38='$line38',line39='$line39',line40='$line40',line41='$line41',line42='$line42',line43='$line43',line44='$line44',line45='$line45',line46='$line46',line47='$line47',line48='$line48',line49='$line49',line50='$line50',line51='$line51',line52='$line52',line53='$line53',line54='$line54',line55='$line55',line56='$line56',line57='$line57',line58='$line58',line59='$line59',line60='$line60',line61='$line61',line62='$line62',line63='$line63',line64='$line64',line65='$line65',line66='$line66' where adm_no ='$adm_no' and name='$name'"; 
 $result9 =mysql_query($query9);
...
$query9= "UPDATE nurses  SET line67='$line67',line68='$line68',line69='$line69',line70='$line70',line71='$line71',line72='$line72',line73='$line73',line74='$line74',line75='$line75',line76='$line76',line77='$line77',line78='$line78',line79='$line79',line80='$line80',line81='$line81',line82='$line82',line83='$line83',line84='$line84',line85='$line85',line86='$line86',line87='$line87',line88='$line88',line89='$line89',line90='$line90',line91='$line91',line92='$line92',line93='$line93',line94='$line94',line95='$line95',line96='$line96',line97='$line97',line98='$line98',line99='$line99',line100='$line100',line101='$line101',line102='$line102',line103='$line103',line104='$line104',line105='$line105',line106='$line106',line107='$line107',line108='$line108',line109='$line109',line110='$line110' where adm_no ='$adm_no' and name='$name'"; 
...
echo "4Yes4";
 ...
 $grand_total = $test_total+$drug_total;
   ...
   $query2= "UPDATE nurses SET status ='To Ward' WHERE adm_no ='$adm_no'";
...
<form action ="addmited_patients_register_doctor.php" method ="GET">
...
if (isset($_GET['search'])){
   ...
   if ($search_by =='Doctor'){
     $query = "select * FROM  nurses WHERE doctor LIKE '%$search%' ORDER BY app_date desc" ;
     $SQL = "select * FROM  nurses WHERE doctor LIKE '%$search%' ORDER BY app_date desc" ;
   }
   if ($search_by =='Diagnosis'){
     $query = "select * FROM nurses WHERE diag1,diag2,diag3 LIKE '%$search%' ORDER BY date desc" ;
     $SQL   = "select * FROM  nurses WHERE diag1,diag2,diag3 LIKE '%$search%' ORDER BY date desc" ;
   }
   if ($search_by =='Name'){
     $query = "select * FROM  nurses WHERE name LIKE '%$search%' ORDER BY name,date desc" ;
     $SQL   = "select * FROM  nurses WHERE name LIKE '%$search%' ORDER BY name,date desc" ;
   }
   if ($search_by =='Date'){
     $query = "select * FROM  nurses WHERE date = '$search' ORDER BY name,date desc" ;
     $SQL   = "select * FROM  nurses WHERE date = '$search' ORDER BY name,date desc" ;
   }
 }else{
   $query= "SELECT * FROM nurses where status ='To Ward' and type='Inpatient'" or die(mysql_error());
   $SQL  = "SELECT * FROM nurses where status ='To Ward' and type='Inpatient'" or die(mysql_error());
}
...
echo"<tr><th width ='20'>Adm No</th><th>Patients Admitted</th><th>Age</th><th>Sex</th><th>Adm Date</th><th>Bed</th><th>Payer</th><th>Days</th></tr>";
...
//      $att_doc = mysql_result($result,$i,"doctor");
      ...
      $bds = mysql_result($result,$i,"adm_date");
      ...
      echo"<td width ='10' align ='left'>$codes</a>";      
      echo"</td>";
      echo"<td width ='200' align ='left'><a href='ward_nurse_edit5.php?accounts3=$bb&accounts=$aa&ref_no=$aa2'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
