...
if (isset($_SESSION['accounts_3'])){    
   ...
   //Go and update the medical file first
   //------------------------------------
   if (isset($_GET['reporter'])){ 
      $reporter = $_GET['reporter'];
      $query0= "UPDATE medicalfile SET reporter='$reporter' WHERE id = '$id_no'";
      $result0 =mysql_query($query0);
   }
   if (isset($_GET['textarea'])){ 
      $summary = $_GET['textarea']; 
      $query0= "UPDATE medicalfile SET manage_summary='$summary' WHERE id = '$id_no'";
      $result0 =mysql_query($query0);
   }

   if (isset($_GET['next_app'])){ 
      $next_app = $_GET['next_app'];
      $query0= "UPDATE medicalfile SET next_app='$next_app' WHERE id = '$id_no'";
      $result0 =mysql_query($query0);
   }
//$_SESSION['accounts_3'] ='';
}
...
<!--div id="section"-->
<OBJECT data="opd_treatment_summary_info.php" type="text/html" style="margin: 0%; width: 100%; height: 650px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
