...
if (isset($_POST['Submit'])){
   $pname = $_POST['user_account'];
   $ppassword = $_POST['password2'];
...
if($found=='Yes'){
//$to = "benarwere@gmail.com,info@selfcare.com";
$subject = "Clock-In";
$headers = $subject;
//$headers .= 'From: <info@hmisglobal.com>' . "\r\n";
//$headers .= 'Cc: benardwere@yahoo.com' . "\r\n";

$date = date('y-m-d');
$message = 'Staff Name: '.$clockname.' Date: '.$date_time;

mail($to,$subject,$message,$headers);
$query= "INSERT INTO clock_in VALUES('$clockname','$date',NOW(),'$ip','','IN')";
...
echo"</select>";
echo"</td></tr>"; 
echo"<tr><td width ='100'><b>Password:</td><td width='50' align='left'><input id='password2' name='password2' required='required' type='password' placeholder='' size ='14' /></td></tr></table>";
...
<br>
<table width ='240' align ='center' border ='0'><td align ='center'>
<input type="submit" name="Submit"  class="button" value="Clock In">
</td></table>
