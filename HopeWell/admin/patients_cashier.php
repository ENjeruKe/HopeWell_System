...
if ($search_by =='Tell'){
     $query = "select * FROM  medicalfile WHERE credit_rate = '$search' ORDER BY name,date desc" ;
     $SQL   = "select * FROM  medicalfile WHERE credit_rate = '$search' ORDER BY name,date desc" ;
   }   
  }else{
...
echo"<tr><th width ='10'>ID</th><th>Click to Edit Patient's Vitals.</th><th>Age</th><th>Sex</th><th>App.Date</th><th>Temp</th><th>Pay Account</th><th>Tell</th></tr>";
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      $doctor = mysql_result($result,$i,"credit_rate");
    ...
    echo"<a href='patients_pha_add_service.php?accounts3=$bb&accounts=$aa&accounts4=$mmdate'>$codes<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      ...
      echo"</td>";
      echo"<td width ='200' align ='left'><a href='../trinity/admin/patients_cashier_edit.php?accounts3=$bb&accounts=$aa&accounts4=$aa4'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
