...
<div class="w3-container w3-teal">
  <h3>Medical | <font color ='yellow'>ADMISSION FORM</font></h3>
</div>
...
<!--div id="section"-->
<OBJECT data="patients_fill_admission.php" type="text/html" style="margin: 0%; width: 100%; height: 650px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
