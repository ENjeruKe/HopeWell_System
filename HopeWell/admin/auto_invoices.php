...
<div class="w3-container w3-teal">
  <h1>Auto Invoices | <font color ='yellow'>Update & Finalise Invoices</font></h1>
</div>
...
<!--div id="section"-->
<OBJECT data="auto_invoice_select.php" type="text/html" style="margin: 0%; width: 100%; height: 450px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
