...
//----------
         ...
         $query4= "INSERT INTO st_trans VALUES('','$store_select','$desc','$patient','-$qty_s','ISP','$date','$username','$rate','$total','$ref_no','$adm_no','','','','','')";
...
<form action ="ip_issuetopatientsx.php" method ="GET">
<?php
 ...
 //while ($row=mysql_fetch_array($hasil)) 
   while ($i7 < $num7)
    ...
    if ($qty > 0){
        ...
        echo"<td width ='10%' align ='left'><input type='text' id ='s_result_three' name='s_result_three' value 
        ='$total'></td>";
    }else{
        echo"<td><!--input type='text' id ='s_amount_three' name='s_amount_three' size='15' value 
        ='$price'--></td>";
        echo"<td><!--input type='text' id ='s_no_three' name='s_no_three' size='15' 
