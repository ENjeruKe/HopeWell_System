...
while ($row=mysql_fetch_array($hasil)) 
   ...
   echo"<tr><td align ='left'><b>$address3</b></td></tr>";
   echo"</table><br>";
   echo"<b>Revenue Accounts</b><img src='space.jpg' style='width:20px;height:2px;'>";
   //echo"<img src='ico/black.jpg' style='width:500px;height:1px;'><br>";
...
$today = date('y/m/d');
$query= "SELECT * FROM revenuef" or die(mysql_error());
$result =mysql_query($query) or die(mysql_error());
$num =mysql_numrows($result) or die(mysql_error());
$tot =0;
$i = 0;
...
echo"<hr>";
//echo"Date<img src='space.jpg' style='width:60px;height:2px;'>";
echo"Account Name<img src='space.jpg' style='width:170px;height:2px;'>";
echo"G/L Account<img src='space.jpg' style='width:120px;height:2px;'>";
echo"Credit Rate<img src='space.jpg' style='width:50px;height:2px;'>";
echo"Cash Rate<img src='space.jpg' style='width:50px;height:2px;'>";
...
echo"<table class='altrowstable' id='alternatecolor'>";
$SQL= "SELECT * FROM revenuef" or die(mysql_error());
$hasil=mysql_query($SQL, $connect);
$id = 0;
$nRecord = 1;
$No = $nRecord;
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      $rate    = mysql_result($result,$i,"cash_rate");   
      $code   = mysql_result($result,$i,"gl_account");   
      $update = mysql_result($result,$i,"credit_rate");  
      $contact = " ";  
      $street  = " ";  
      $pay_mode= " ";  
