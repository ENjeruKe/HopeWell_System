...
if (isset($_GET['billing']))
  ...
  //Asign ECT value if selected
   ...
   if ($gledger=='ECT-INCOME'){
      ...
      $query= "INSERT INTO htransf 
      VALUES('$adm_no','$patient','$date','$ref_no','$desc','DB','$amount','$chargable','$gledger','DB','$ref_no','ADMIN','    
      ','$mydate','1','$pay_company')";
   }
...
$cdquery="SELECT patients_name,adm_no FROM clients where adm_date<>'0000-00-00 00:00:00' ORDER BY patients_name ";
$cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());
