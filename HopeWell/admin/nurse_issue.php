...
<div class="wrapper">
  	...
  	<?php include 'includes/medic/nurses.php'; ?>
...
if (isset($_GET['save_cancel'])){
   ...
   $query = "select * FROM stock_issp WHERE description <>'' and qty<>0";
...
//----------
         ...
         $query4= "INSERT INTO st_trans VALUES('$cost_location','$desc','$patient',
'-$qty_s','ISP','$date','ADMIN','$rate','$total','$ref_no','$adm_no','','','','','')";
      ...
      //   $query4= "INSERT INTO st_trans_long VALUES('$location1','$desc','$patient',
      //   '$qty_s','ISP','$date','ADMIN','$rate','$total','$ref_no','$adm_no')";
      //   $result4 =mysql_query($query4);
      //}
...
echo"<table bgcolor ='red' border = '0' border color = 'black' width ='100%'><th width ='500' align ='left'>Item Description</th><th width ='100' align ='left'>Price</th><th width ='220' center>Qty</th><th width ='220' align ='center'>Total</th><th width ='100'>Action</th></th></table>";
 ...
 $query7= "SELECT * FROM stock_issp" or die(mysql_error());
 $result7 =mysql_query($query7) or die(mysql_error());
 $num7 =mysql_numrows($result7) or die(mysql_error());
 $tot =0;
 $i7 = 0;
 ...
 //while ($row=mysql_fetch_array($hasil)) 
   while ($i7 < $num7)
    ...
    if ($qty > 0){
        echo"<td align ='right'><input type='text' id ='s_amount_three' name='amount_three' size='10' value 
        ='$price' style='text-align:right;'></td>";
        echo"<td align ='right'><input type='text' id ='s_no_three' name='s_no_three' size='10' value ='$qty' style='text-align:right;'></td>";
        echo"<td><input type='text' id ='s_result_three' name='s_result_three' size='10' value 
        ='$total' style='text-align:right;'></td>";
    }else{
      ...
      //$aa8=$row['id'];        
if ($qty <>0){
echo"<td width ='100' align ='right'><a href='ip_issuetopatients.php?accounts5=$aa8'>Del<img src='ico/Info.ico' alt='Smiley face' height='12' width='12'></a></td>";
}else{
...
if (isset($_GET['save_cancel77'])){
   ...
   while ($i < $num)
      ...
      //Add Qty in file
      $query2 = "select * FROM stock_issp WHERE description ='$desc' AND location ='$codes'" ;
      $result2 =mysql_query($query2) or die(mysql_error());
      $id = 0;
      $nRecord = 1;
      $No = $nRecord;
