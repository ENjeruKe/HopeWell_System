...
echo 'Step1';
      ...
      if (isset($_GET['test1_result'])){
         ...
         $query3= "UPDATE medicalfile SET test1_result='$test1_result' WHERE ref_no ='$ref_nos'";
         $result3 =mysql_query($query3);
      }
      if (isset($_GET['test2_result'])){
         $test2_result  =$_GET['test2_result'];
         $query3= "UPDATE medicalfile SET test2_result='$test2_result' WHERE ref_no ='$ref_nos'";
         $result3 =mysql_query($query3);
      }
      if (isset($_GET['test3_result'])){
         $test3_result  =$_GET['test3_result'];
         $query3= "UPDATE medicalfile SET test3_result='$test3_result' WHERE ref_no ='$ref_nos'";
         $result3 =mysql_query($query3);
      }
      if (isset($_GET['test4_result'])){
         $test4_result  =$_GET['test4_result'];
         $query3= "UPDATE medicalfile SET test4_result='$test4_result' WHERE ref_no ='$ref_nos'";
         $result3 =mysql_query($query3);
      }
      if (isset($_GET['test5_result'])){
         $test5_result  =$_GET['test5_result'];
         $query3= "UPDATE medicalfile SET test5_result='$test5_result' WHERE ref_no ='$ref_nos'";
         $result3 =mysql_query($query3);   
      } 
...
<form action ="patients_register_radiology.php" method ="GET">
...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM medicalfile where status ='To Radiology' and date ='$mdate' ORDER BY date DESC" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where status ='To Radiology'and date ='$mdate' ORDER BY date DESC" or die(mysql_error());
}
