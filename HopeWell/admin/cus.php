...
$username = $_SESSION['username'];
			...
			include('includes/connect.php');
				$result = $db->prepare("SELECT * FROM attendance WHERE time_out='00:00:00' and status<>'Closed' ORDER BY status ASC");
				$result->execute();
...
?>
			...
			<a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Close Shift </button></a></td>
			</tr>
			<?php
				}
			?>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Are you sure you want to close the Shift? There is NO undo!"))
		  {
