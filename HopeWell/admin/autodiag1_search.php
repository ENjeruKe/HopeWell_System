...
define ("DB_PASS","0710958791"); // set database password
define ("DB_NAME","wama3"); // set database name
...
$query = 'SELECT name, name FROM diseasefile WHERE name LIKE "%'.$user_input.'%" ';
