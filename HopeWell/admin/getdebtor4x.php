...
if (isset($_GET['save_cancel'])){
   ...
   while ($i < $num)
     ...
     //---------------------------------
     $query5= "INSERT INTO dtransf VALUES('','$account_name','$mydates','Cheque  Allocation','$ref_no','Pay','Pay','$tot_amt','$balancez','$username')";
...
if (isset($_GET['q'])){
 ...
 $result3 =mysql_query($query3) or die(mysql_error());
   ...
   while ($i3 < $num3)
    ...
    echo"<a href='debtors_statementx.php'>Refresh Page</a>";
}
...
$all_bal=$all_bal;   
echo"<table width ='100%'><td width ='20%'><a href='getdebtor4.php?accountsspay=100x&accounts33=100000'></a></td><td width ='80%' align='right'><h3>Balance:</h3></td><td width='20%' align='left'><h3>$all_bal</h3></td></tr>"; 
...
echo"</td><td width ='100' align ='right'></td><td width ='100'></td><td width ='100'><td></td><td width ='100' align ='right'><h3></b></td><td><b></b></td></font>";
