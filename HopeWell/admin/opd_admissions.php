...
$adm_date = $adm_time;
   ...
   //-------------------------------------------
   $query3 = "select * FROM medicalfile WHERE date ='$date'" ;
   $result3 =mysql_query($query3) or die(mysql_error());
   $num3 =mysql_numrows($result3) or die(mysql_error());
   $i3=0;
   $exist ='No';
   ...
   if ($exist=='Yes'){
      $query= "UPDATE medicalfile SET type ='Inpatient',status='To Ward' WHERE ref_no ='$invoice'";
      $result =mysql_query($query);
   }
...
<body>
<form action ="opd_admissions.php" method ="GET">
<?php
...
echo"<tr><td width ='600' align ='left'><b>Condition on Admission</b>
