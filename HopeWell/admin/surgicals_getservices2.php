...
<form action ="aller.php" method ="GET">
...
if($payer ==''){
$sql="SELECT * FROM stockfile WHERE location ='MAIN STORE' and description = '".$q2."' ";
...
echo"<tr><td width ='150'>Dosage:</td><td><input name='dosage' type='text' size ='50' required></td>";
