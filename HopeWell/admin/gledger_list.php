...
while ($row=mysql_fetch_array($hasil)) 
   ...
   echo"<tr><td align ='left'><b>$address3</b></td></tr>";
   echo"</table><br>";
   echo"<b>Chart of Accounts</b><img src='space.jpg' style='width:20px;height:2px;'>";
   //echo"<img src='ico/black.jpg' style='width:500px;height:1px;'><br>";
...
$today = date('y/m/d');
$query= "SELECT * FROM glaccountsf" or die(mysql_error());
$result =mysql_query($query) or die(mysql_error());
$num =mysql_numrows($result) or die(mysql_error());
$tot =0;
$i = 0;
...
echo"Type<img src='space.jpg' style='width:180px;height:2px;'>";
echo"Balance.<img src='space.jpg' style='width:50px;height:2px;'>";
echo"Reg. Date<img src='space.jpg' style='width:100px;height:2px;'>";
//echo"Balance<img src='space.jpg' style='width:50px;height:2px;'>";
echo"</b></div>";
echo"<hr>";
...
echo"<table class='altrowstable' id='alternatecolor'>";
$SQL= "SELECT * FROM glaccountsf" or die(mysql_error());
$hasil=mysql_query($SQL, $connect);
$id = 0;
$nRecord = 1;
$No = $nRecord;
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      $code   = mysql_result($result,$i,"type");   
      $update = '';
      //mysql_result($result,$i,"register_date");  
      $contact = " ";  
      $street  = " ";  
      $pay_mode= " ";  
      ...
      echo"<td width ='150' align ='centre'>";      
      echo"$update";      
      echo"</td>";
