...
if (isset($_GET['save_cancel']))
   ...
   $topay = 0;
   $tot_amt = $paid;
   $query3 = "select * FROM suppliersfile WHERE account_name ='$payer'" ;
   $result3 =mysql_query($query3) or die(mysql_error());
   $num3 =mysql_numrows($result3) or die(mysql_error());
   $i3=0;
   while ($i3 < $num3)
     ...
     $query= "UPDATE suppliersfile SET os_balance ='$balance2' WHERE account_name ='$payer'";
   ...
   VALUES('','$date','$credit_account','$ref_no','INV','$payer','-$paid','admin','$company_identity')";
   ...
   $query2= "UPDATE glaccountsf SET balance ='$db_balance' WHERE account_name ='$credit_account'";
   ...
   //-------------------------------------
   $query5= "INSERT INTO gltransf VALUES('','$date','$debit_account','$ref_no','INV','$payer','$paid','admin','$company_identity')";
   $result5 =mysql_query($query5);


     $query  = "INSERT INTO supplierstrfile 
VALUES('','PHARMACY','$payer','$date','$ref_no3','$narration','INV','$paid','INV','$ref_no3','$username','','$date','1','$payer','$paid')";
     $result =mysql_query($query);
   ...
   while ($i3 < $num3)
     ...
     $query2= "UPDATE glaccountsf SET balance ='$credit_balance' WHERE account_name ='$debit_account'";
     $result2 =mysql_query($query2);
...
echo"<tr><td width ='100' align ='left'><b>Suppliers A/c:</b></td><td>";
