...
VALUES('$company_identity','$payer','$date','$ref_no3','$narration','CR','-$paid','SUP','$ref_no','$username','$narration','$date','','$payer','-$paid')";
     $result =mysql_query($query);
...
<form action ="post_credit_supplier.php" method ="GET">
<?php
...
//echo"<table width ='500' border='0' border color ='red'><td align ='right'><h1>Suppliers Credit Note</h1></td>
//</table>";      
...
echo"<tr><td width ='100' align ='left'><b>Supplier A/c:</b></td><td>";
