...
$today = date('y/m/d');
if ($search==''){
$query  = "select * FROM st_trans WHERE trans_desc ='ADJ' and date >='$date1' and date <= '$date2' ORDER BY date" ;
}else{
$query  = "select * FROM st_trans WHERE trans_desc ='ADJ' and location='$search' and date >='$date1' and date <= '$date2' ORDER BY date" ;
}
...
echo"<th><h3>Stock Adjustment Report</h3></th></tr>";
//echo"<div><b>";
echo"<hr>";
//echo"Date<img src='space.jpg' style='width:80px;height:2px;'>";
//echo"Department<img src='space.jpg' style='width:100px;height:2px;'>";
//echo"Item Description<img src='space.jpg' style='width:240px;height:2px;'>";
//echo"Inputby<img src='space.jpg' style='width:200px;height:2px;'>";
//echo"Qty<img src='space.jpg' style='width:40px;height:2px;'>";
//echo"Cost<img src='space.jpg' style='width:40px;height:2px;'>";
//echo"Total<img src='space.jpg' style='width:20px;height:2px;'>";
//echo"</b></div>";
//echo"<hr>";


echo"<table class='altrowstable' id='alternatecolor' border ='0' width ='100%'>";
echo"<tr><th bgcolor ='black'><font color ='white'>Date</th><th bgcolor ='black'><font color ='white'>Department</th><th bgcolor ='black'><font color ='white'>Item Description</th><th bgcolor ='black'><font color ='white'>Input by</th><th bgcolor ='black' align ='left'><font color ='white'>Qty</th><th align ='left' bgcolor ='black'><font color ='white'>Cost</th><th align ='left' bgcolor ='black'><font color ='white'>Total</font></th></tr>";
if ($search==''){
$SQL ="select * FROM st_trans WHERE trans_desc ='ADJ' and date >='$date1' and date <= '$date2' ORDER BY date" ;
}else{
$SQL ="select * FROM st_trans WHERE location='$search' and trans_desc ='ADJ' and date >='$date1' and date <= '$date2' ORDER BY date" ;
}
...
while ($row=mysql_fetch_array($hasil)) 
      ...
      $dept    = mysql_result($result,$i,"location");  
...
$net_tot = 0;
   ...
   echo"<form action ='stock_adj_rpt.php' method ='GET'>";
 ...
 echo"<tr><td>Date Range From</td><td><input type='text' name='date1' value ='$date1' size='12' ></td></tr><tr><td> To 
