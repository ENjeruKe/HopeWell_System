...
<form action ="in_patients_register_nurses.php" method ="GET">
...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM medicalfile where date <>'' and (type='InPatient' or status='To Ward') ORDER BY adm_no" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where date <>'' and (type='InPatient' or status='To Ward') ORDER BY adm_no" or die(mysql_error());
}
...
echo"<tr><th width ='10'>ID</th><th>Click to Edit Patient's Vitals.</th><th>Age</th><th>Sex</th><th>App.Date</th><th>Bed No</th><th>Doctor</th><th>Days In</th></tr>";
...
while ($row=mysql_fetch_array($hasil)) 
 ...
 $das_in = $mdate - $update;
      ...
      echo"<td width ='10' align ='left'><a href=javascript:popcontact2('debit_notes.php?accounts3=$bb&accounts=$aa&ref_no=$aa2')>$codes</a>";      
      echo"</td>";
      echo"<td width ='200' align ='left'><a href='in_patients_nurses_edit5.php?accounts3=$bb&accounts=$aa&ref_no=$aa2'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
