...
<form action="saveconsumer.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Add Consumer Dept</h4></center>
<hr>
<div id="ac">
<span>Name : </span><input type="text" style="width:265px; height:30px;" name="name" required/><br>
<!--span>Disease : </span><input type="text" style="width:265px; height:30px;" name="drugs_used" /><br-->
