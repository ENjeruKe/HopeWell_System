...
<form action ="opd_treatment_summary_info.php" method ="GET">
...
if (isset($_GET['search'])){
   ...
   $query= "SELECT * FROM medicalfile where date ='$mdate' and type='Outpatient' ORDER BY name,date DESC" or die(mysql_error());
   $SQL  = "SELECT * FROM medicalfile where date ='$mdate' and type='Outpatient' ORDER BY name,date ORDER BY name DESC" or die(mysql_error());
}
...
while ($row=mysql_fetch_array($result)) 
      ...
      echo"</td>";
      echo"<td width ='350' align ='left'><a href='print_opd_treatment_summary.php?accounts3=$bb&accounts=$aa&ref_no=$aa2'>$desc<img src='ico/Profile.ico' alt='statement' height='12' width='12'></a>";
      echo"</td>";            
      echo"<td width ='30'>";      
      echo"$age";
      echo"</td>";      
