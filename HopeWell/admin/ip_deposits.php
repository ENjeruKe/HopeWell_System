...
<div class="w3-container w3-teal">
  <h1>In-Patient Deposits | <font color ='red'>HMIS</font></h1>
</div>
...
<!--input type="submit" name="Submit"  class="button" value="Add New Patient" onclick="return popitup('patients_reg_add2.php')"/-->

<!--input type="submit" name="Submit"  class="button" value="Clients Register" onclick="return popitup('patient_register2.php')"/-->
...
<!--input type="submit" name="Submit"  class="button" value="Post Receipt"  onclick="return popitup('patients_receipt.php')"/-->
...
<!--div id="section"-->
<OBJECT data="patient_deposits.php" type="text/html" style="margin: 0%; width: 100%; height: 450px; padding 0px; text-align:left;"></OBJECT>
<!--/div-->
