...
source: "autosigns1_search.php?cityId=28",
minLength: 2,
...
function showUser(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_signs.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUser2(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_signs2.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUser3(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_signs3.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUser4(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_signs4.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
function showUser5(str) { 
    ...
    //var no = document.getElementById('dd_user_input').value;   
        ...
        xmlhttp.open("GET","getservices_signs5.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
$sign2 = $_SESSION['sign2'];
$sign3 = $_SESSION['sign3'];
$sign4 = $_SESSION['sign4'];
$sign5 = $_SESSION['sign5'];


echo"<input id='dd_user_input3' type='text' size ='100' class='search_form3' onblur='if(this.value=='')this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value='';' value='$sign1' onchange='showUser(this.value)'";
?>
/><br>

<?php
echo"<input id='dd_user_input4' type='text' size ='100' class='search_form4' onblur='if(this.value=='')this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value='';' value='$sign2' onchange='showUser2(this.value)'";
?>
/><br>

<?php
echo"<input id='dd_user_input5' type='text' size ='100' class='search_form5' onblur='if(this.value=='')this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value='';' value='$sign3' onchange='showUser3(this.value)'";
?>
/><br>

<?php
echo"<input id='dd_user_input6' type='text' size ='100' class='search_form6' onblur='if(this.value=='')this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value='';' value='$sign4' onchange='showUser3(this.value)'";
?>
/><br>


<?php
echo"<input id='dd_user_input7' type='text' size ='100' class='search_form7' onblur='if(this.value=='')this.value=this.defaultValue;' onfocus='if(this.value==this.defaultValue)this.value='';' value='$sign5' onchange='showUser3(this.value)'";
?>
/><br>
...
<div class="in_subs"><input type="text" onblur="if$diag2 = $_SESSION['diag2'];
...
$diag2 = $_SESSION['diag2'];
$diag3 = $_SESSION['diag3'];
(this.value=='')this.value=this.defaultValue;" onfocus="if(this.value==this.defaultValue)this.value='';" value="Enter your email address:" name="email" style="width:258px; height:30px; float:left; border: 2px double #DDDDDD;"></div>
