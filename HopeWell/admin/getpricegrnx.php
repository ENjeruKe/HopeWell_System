...
echo"<form action ='stock_grnx.php' method ='GET'>";
 echo"<table border = '0' width ='100%'>";
 echo"<td width='10%'><input type='text' id ='search_id' name='search_id' size ='5' value ='$search_id'</td>";
 //echo"<td width ='5'></td>";
echo"<td width ='25%'><input type='text' id ='item1' name='item1' size ='110' value ='$description'</td>";
//echo"<td width ='5'></td>";
echo"<td width ='5%'><input type='text' id ='amount_three' name='amount_three' size='7' value ='$item_price' readonly></td>";
 echo"<td width ='5%'><input type='text' id ='no_three' name='no_three' size='7' onchange='function3()'></td>";
 echo"<td width ='5%'></td><td><input type='text' id ='result_three' name='result_three' size='7'></td>";
 echo"<td width ='5%'></td><td><input type='text' id ='result_three' name='batch' size='7' required></td>";
 echo"<td width ='5%'></td><td><input type='date' id ='result_three' name='expiry' size='10' required></td>";
 
$_SESSION['old_balance'] =$_qtys;
//echo"<td width ='10%'></td>";
echo"<td width ='10%' align ='right'><font color ='blue'>Bal.$_qtys .Price:.$price </td>";
